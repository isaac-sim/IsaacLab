...
.. code-block:: bash
    ...
    uvx isaaclab demo procedural-terrain --color_scheme height

    # Generate terrain with random color scheme
    uvx isaaclab demo procedural-terrain --color_scheme random

    # Generate terrain with no color scheme
    uvx isaaclab demo procedural-terrain --color_scheme none

    # Generate terrain with curriculum
    uvx isaaclab demo procedural-terrain --use_curriculum

    # Generate terrain with curriculum along with flat patches
    uvx isaaclab demo procedural-terrain --use_curriculum --show_flat_patches
