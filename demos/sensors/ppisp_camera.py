...
.. code-block:: bash
    ...
    uvx isaaclab demo ppisp-camera \
...
# Camera output is required, but the demo does not need an interactive visualizer.
...
class PpispCameraSceneCfg(InteractiveSceneCfg):
    ...
    anchor = RigidObjectCfg(
        ...
        spawn=sim_utils.CuboidCfg(
            ...
            physics_material=sim_utils.UsdPhysicsRigidBodyMaterialCfg(),
...
def run_simulator(sim: sim_utils.SimulationContext, baseline_camera: Camera, ppisp_camera: Camera) -> None:
    ...
    if output_dir is None:
        output_dir = os.path.join(os.getcwd(), "output", "ppisp_camera")
