...
.. code-block:: bash
    ...
    # with allegro hand
    isaaclab demo multi-mesh-ray-caster --num_envs 16 --asset_type allegro_hand

    # with anymal-D bodies
    isaaclab demo multi-mesh-ray-caster --num_envs 16 --asset_type anymal_d

    # with random multiple objects
    isaaclab demo multi-mesh-ray-caster --num_envs 16 --asset_type objects

    # with Newton (MJWarp) physics
    isaaclab demo multi-mesh-ray-caster --physics newton_mjwarp
