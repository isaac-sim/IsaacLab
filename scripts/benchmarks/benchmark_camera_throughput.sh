...
run_with_watchdog ${ISAACLAB_SH} -p ${SCRIPT_PATH}/benchmark_camera_throughput.py --resolutions 64x64,120x160 --num_envs 12 24 48 96 --tiled_camera --usd_camera --data_type rgb
run_with_watchdog ${ISAACLAB_SH} -p ${SCRIPT_PATH}/benchmark_camera_throughput.py --resolutions 64x64,120x160 --num_envs 12 24 48 96 --tiled_camera --ray_caster_camera --usd_camera --data_type distance_to_image_plane
...
run_with_watchdog ${ISAACLAB_SH} -p ${SCRIPT_PATH}/benchmark_camera_throughput.py --resolutions 240x320,480x640 --num_envs 96 256 512 --tiled_camera --ray_caster_camera --data_type distance_to_image_plane
