...
"""Smoke test for scripts/benchmarks/play.py with --rl_library rl_games.
...
def test_play_rl_games_emits_play_bundle(tmp_path, require_isaacsim):
    sh = ROOT / "isaaclab.sh"
    ...
    ckpt = _newest_checkpoint("logs/rl_games/**/*.pth", start)
