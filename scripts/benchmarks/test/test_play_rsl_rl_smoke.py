...
"""Smoke test for scripts/benchmarks/play.py with --rl_library rsl_rl.
...
def test_play_rsl_rl_emits_play_bundle(tmp_path, require_isaacsim):
    sh = ROOT / "isaaclab.sh"
    ...
    ckpt = _newest_checkpoint("logs/rsl_rl/**/model_*.pt", start)
