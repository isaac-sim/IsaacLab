...
class PvaSensorSceneCfg(InteractiveSceneCfg):
    ...
    pva_LF: Any = config_field(PvaCfg(prim_path="{ENV_REGEX_NS}/Robot/LF_FOOT", debug_vis=True))

    pva_RF: Any = config_field(PvaCfg(prim_path="{ENV_REGEX_NS}/Robot/RF_FOOT", debug_vis=True))
