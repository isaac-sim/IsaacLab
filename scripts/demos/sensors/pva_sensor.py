...
class PvaSensorSceneCfg(InteractiveSceneCfg):
    ...
    pva_LF: Any = field(default_factory=lambda: PvaCfg(prim_path="{ENV_REGEX_NS}/Robot/LF_FOOT", debug_vis=True))

    pva_RF: Any = field(default_factory=lambda: PvaCfg(prim_path="{ENV_REGEX_NS}/Robot/RF_FOOT", debug_vis=True))
