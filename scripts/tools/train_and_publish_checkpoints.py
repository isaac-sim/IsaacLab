...
* To train an agent using the rl_games workflow on the Isaac-Cartpole-Manager environment:

  .. code-block:: shell

    python scripts/tools/train_and_publish_checkpoints.py --train rl_games:Isaac-Cartpole-Manager
...
Examples:
    # Train an agent using the rl_games workflow for the Isaac-Cartpole-Manager environment.
    train_and_publish_checkpoints.py --train rl_games:Isaac-Cartpole-Manager
