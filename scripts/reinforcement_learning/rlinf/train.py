...
warnings.warn(
    ...
    "`./isaaclab.sh -p scripts/reinforcement_learning/train.py --library rlinf --config_name <CONFIG_NAME>` instead. "
    "Example: `./isaaclab.sh -p scripts/reinforcement_learning/train.py --library rlinf "
    "--config_name isaaclab_ppo_gr00t_assemble_trocar`.",
    DeprecationWarning,
    stacklevel=1,
)
