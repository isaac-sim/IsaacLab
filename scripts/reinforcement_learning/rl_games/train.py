...
warnings.warn(
    ...
    "`./isaaclab.sh -p scripts/reinforcement_learning/train.py --library rl_games --task <TASK>` instead. "
    "Example: `./isaaclab.sh -p scripts/reinforcement_learning/train.py --library rl_games --task Isaac-Cartpole-v0`.",
    DeprecationWarning,
    stacklevel=1,
)
