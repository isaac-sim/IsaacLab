...
warnings.warn(
    ...
    "`./isaaclab.sh -p scripts/reinforcement_learning/train.py --library skrl --task <TASK>` instead. "
    "Example: `./isaaclab.sh -p scripts/reinforcement_learning/train.py --library skrl --task Isaac-Cartpole-v0`.",
    DeprecationWarning,
    stacklevel=1,
)
