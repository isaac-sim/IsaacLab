...
def _load_runtime_dependencies() -> None:
    ...
    global ensure_env_spec_id, get_published_pretrained_checkpoint
...
def export_rl_games_agent(
    ...
    if args_cli.checkpoint == "pretrained":
        resume_path = get_published_pretrained_checkpoint("rl_games", checkpoint_task_name, env_cfg=env_cfg)
        if not resume_path:
