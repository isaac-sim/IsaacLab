...
def _load_runtime_dependencies() -> None:
    ...
    global ensure_env_spec_id, get_published_pretrained_checkpoint_for_env
...
def export_skrl_agent(
    ...
    if args_cli.checkpoint == "pretrained":
        resume_path = get_published_pretrained_checkpoint_for_env("skrl", checkpoint_task_name, env_cfg, args_cli.agent)
        if not resume_path:
