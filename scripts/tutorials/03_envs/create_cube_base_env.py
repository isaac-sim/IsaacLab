...
class CubeEnvCfg(ManagerBasedEnvCfg):
    ...
    scene: MySceneCfg = field(
        default_factory=lambda: MySceneCfg(num_envs=args_cli.num_envs, env_spacing=2.5, replicate_physics=False)
    )
