...
from isaaclab.devices import Se3Gamepad, Se3Keyboard, Se3SpaceMouse, Se3Keyboard_BMM, Oculus_mobile
...
def main():
    ...
    if args_cli.teleop_device.lower() == "keyboard":
        ...
        teleop_interface = Oculus_mobile(
            pos_sensitivity=0.8 * args_cli.sensitivity, rot_sensitivity=1.0 * args_cli.sensitivity, base_sensitivity = 0.10 * args_cli.sensitivity
        )
