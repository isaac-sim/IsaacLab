...
class MimicRecorderManagerCfg(ActionStateRecorderManagerCfg):
    ...
    record_pre_step_datagen_info: Any = field(default_factory=PreStepDatagenInfoRecorderCfg)
    record_pre_step_subtask_start_signals: Any = field(default_factory=PreStepSubtaskStartsObservationsRecorderCfg)
    record_pre_step_subtask_term_signals: Any = field(default_factory=PreStepSubtaskTermsObservationsRecorderCfg)
