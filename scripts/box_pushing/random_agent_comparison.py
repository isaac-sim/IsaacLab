...
"""Run Isaac Lab and FancyGym box pushing side by side with random actions."""
...
parser = argparse.ArgumentParser(description="Random-action comparison between Isaac Lab and FancyGym.")
parser.add_argument(
    "--disable_fabric",
    action="store_true",
    default=False,
...
def main():
    """Run both simulators with the same random actions."""
    ...
    num_envs = args_cli.num_envs or env.unwrapped.num_envs
