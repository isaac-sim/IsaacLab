...
class Test_UV_Smoke(UV_Utils):
    ...
    def test_isaaclab_sh_uv_creates_env_with_python_312(self, isaaclab_root):
        ...
        try:
            ...
            version_output = self.run_in_env(["python", "--version"], check=False).stdout.strip()
    ...
    def test_isaaclab_install_assets(self, isaaclab_root):
        ...
        try:
            ...
            result = self.run_in_env([str(self.cli_script), "-i", "assets"], cwd=isaaclab_root, check=False)
    ...
    def test_isaaclab_newton_installs_isaaclab_physx(self, isaaclab_root):
        ...
        try:
            ...
            result = self.run_in_env([str(self.cli_script), "-i", "newton"], cwd=isaaclab_root, check=False)
