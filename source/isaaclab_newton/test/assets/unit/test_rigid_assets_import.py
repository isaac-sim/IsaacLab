...
_TARGETS = (
    ...
    ("test_articulation.py", "test_articulation_joint_and_body_properties_round_trip"),
    ("test_articulation.py", "test_articulation_drive_and_dynamics"),
    ("test_articulation.py", "test_floating_articulation_root_and_wrench_response"),
