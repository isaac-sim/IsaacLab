...
# The initialization test covers scalar and batched environment/object shapes.
# Subsequent behavior tests use their largest existing case, retaining both
# environment and collection vectorization without rebuilding every smaller
# Cartesian-product variant.
