...
class TestProcessCfg:
    ...
    def test_process_cfg_offsets_spawned_pose(self, device: str):
        ...
        rigid_object.cfg.init_state.pos = (1.0, 2.0, 3.0)
        rigid_object.cfg.init_state.rot = (0.0, 0.0, 0.0, 1.0)  # x, y, z, w (identity)
    ...
    def test_process_cfg_offsets_spawned_pose_zero_offset(self, device: str):
        ...
        rigid_object.cfg.init_state.pos = (0.0, 0.0, 0.0)
        rigid_object.cfg.init_state.rot = (0.0, 0.0, 0.0, 1.0)  # x, y, z, w
    ...
    def test_process_cfg_offsets_spawned_pose_with_rotation(self, device: str):
        ...
        rigid_object.cfg.init_state.pos = (1.0, 2.0, 5.0)
        rigid_object.cfg.init_state.rot = (0.0, 0.0, 0.707, 0.707)  # x, y, z, w
