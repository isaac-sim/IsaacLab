...
def author_fixed_spatial_chain(
    *,
    actuators: dict | None = None,
    prim_paths: Sequence[str] = ("/World/Robot",),
    prim_path_expr: str | None = None,
) -> Articulation:
    """Author one or more fixed chains with full-rank spatial Jacobians."""
    ...
    return Articulation(
        ArticulationCfg(
            prim_path=prim_path_expr or prim_paths[0],
