...
class FrameTransformer(BaseFrameTransformer):
    ...
    * Entries 1..M per env — target sites measured w.r.t. source site.
    ...
    def __init__(self, cfg: FrameTransformerCfg):
        ...
        self._data.target_frame_names = [t.name or t.prim_path.rsplit("/", 1)[-1] for t in cfg.target_frames]
    ...
    def find_bodies(self, name_keys: str | Sequence[str], preserve_order: bool = False) -> tuple[list[int], list[str]]:
        return resolve_matching_names(name_keys, self._data.target_frame_names, preserve_order)
