...
class MPMObjectCfg(DeformableObjectCfg):
    ...
    cloning_contexts: tuple[str | type, ...] | None = config_field(("isaaclab_newton.cloner:NewtonReplicateContext",))
    ...
    class_type: type[MPMObject] | str = config_field("{DIR}.mpm_object:MPMObject")

    spawn: MPMParticleSpawnerCfg = config_field(MISSING)
