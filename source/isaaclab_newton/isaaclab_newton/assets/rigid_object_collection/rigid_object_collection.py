...
class RigidObjectCollection(BaseRigidObjectCollection):
    ...
    def num_shapes(self) -> int:
        """Total number of collision shapes in the rigid object collection."""
    ...
    def _create_buffers(self):
        ...
        self._ALL_SHAPE_INDICES = wp.array(
            np.arange(self.num_shapes, dtype=np.int32), device=self.device, dtype=wp.int32
        )
