...
class NewtonSolverCfg:
    ...
    class_type: type[NewtonManager] | str = "isaaclab_newton.physics.newton_manager:NewtonManager"
...
class NewtonCfg(PhysicsCfg):
    ...
    default_shape_cfg: NewtonShapeCfg = field(default_factory=NewtonShapeCfg)
    ...
    def __post_init__(self):
        ...
        resolve_config(self.solver_cfg)
