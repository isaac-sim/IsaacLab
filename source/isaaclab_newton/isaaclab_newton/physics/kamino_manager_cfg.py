...
def _non_none_kwargs(cfg: Any) -> dict[str, Any]:
    """Return ``config_to_dict(cfg)`` entries with ``None`` values omitted."""
...
class _KaminoSolverCfgBase(NewtonSolverCfg):
    ...
    class_type: type[NewtonManager] | str = "isaaclab_newton.physics.kamino_manager:NewtonKaminoManager"
