...
class NewtonRigidBodyPropertiesCfg(RigidBodyBaseCfg):
    ...
    .. deprecated:: 3.0
        ...
        :class:`MujocoRigidBodyCfg` only for ``gravcomp``. This class will be removed in 4.0.
    """
...
class NewtonJointDrivePropertiesCfg(JointDriveBaseCfg):
    ...
    .. deprecated:: 3.0
        ...
        fragment: it is a field on the spawner cfg. This class will be removed in 4.0.
    """
...
class MujocoJointDrivePropertiesCfg(NewtonJointDrivePropertiesCfg):
    ...
    .. deprecated:: 3.0
        ...
        cfg. This class will be removed in 4.0.
    """
...
class NewtonCollisionPropertiesCfg(CollisionBaseCfg):
    ...
    .. deprecated:: 3.0
        ...
        the spawner's ``mesh_collision_props`` slot instead. This class will be removed in 4.0.
    """
...
class NewtonMeshCollisionPropertiesCfg(NewtonCollisionPropertiesCfg, MeshCollisionBaseCfg):
    ...
    .. deprecated:: 3.0
        ...
        the inherited fields. This class will be removed in 4.0.
    """
...
class NewtonSDFCollisionPropertiesCfg(NewtonCollisionPropertiesCfg):
    ...
    .. deprecated:: 3.0
        ...
        drop the inherited fields. This class will be removed in 4.0.
    """
