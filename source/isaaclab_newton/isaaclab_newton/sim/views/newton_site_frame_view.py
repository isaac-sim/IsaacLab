...
class NewtonSiteFrameView(BaseFrameView):
    ...
    def get_local_scales(self, indices: wp.array | None = None) -> ProxyArray:
        ...
        .. note::
            Newton stores shape_scale as the effective (composed) scale.
    ...
    def set_local_scales(self, scales: wp.array, indices: wp.array | None = None) -> None:
        ...
        .. note::
            Newton stores shape_scale as the effective (composed) scale.
            set_local_scales writes directly to shape_scale.
        """
    ...
    def _set_shape_scales(self, scales: wp.array, indices: wp.array | None = None) -> None:
        """Internal: write shape_scale to Newton model."""
        model = NewtonManager.get_model()
        num_shapes = model.shape_count
