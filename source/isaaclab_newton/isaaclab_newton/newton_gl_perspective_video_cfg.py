...
class NewtonGlPerspectiveVideoCfg:
    ...
    class_type: type[Any] | str = "isaaclab_newton.newton_gl_perspective_video:NewtonGlPerspectiveVideo"
    """Implementation class; default is :class:`~isaaclab_newton.newton_gl_perspective_video.NewtonGlPerspectiveVideo`."""
