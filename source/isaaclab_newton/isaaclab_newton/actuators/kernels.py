...
def compute_pd_actuator(
    pos_tgts: wp.array2d(dtype=wp.float32),
    vel_tgts: wp.array2d(dtype=wp.float32),
    ...
    if env_mask[env_index] and joint_mask[joint_index]:
        computed_effort[env_index, joint_index] = (
            stiffness[env_index, joint_index] * (pos_tgts[env_index, joint_index] - joint_pos[env_index, joint_index])
            + damping[env_index, joint_index] * (vel_tgts[env_index, joint_index] - joint_vel[env_index, joint_index])
