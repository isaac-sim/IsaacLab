...
def cli() -> None:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "  Installed by 'all' or by explicit token. Selectors install their optional\n"
            "  dependency extras:\n"
            "    contrib[rlinf]\n"
            ...
            "\n"
            "* Special values:\n"
            "  all   - Core + optional submodules (contrib, mimic, ov, teleop) + auto\n"
            "          extra features (newton, rl, visualizer). Does not install\n"
            "          contrib/ov dependency extras (default).\n"
            "  none  - Core submodules only; no optional submodules, no extra features.\n"
            "  <empty> (-i with no value) - Same as 'all'.\n"
            "\n"
            "Note: contrib and ov dependency extras require selectors:\n"
