...
def cli() -> None:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "  The 'ov' token installs the full renderer/physics collection (ovphysx + ovrtx).\n"
            ...
            "\n"
            "Note: Contrib and OV source packages are core. Contrib runtime dependencies\n"
            "require a selector; the 'ov' token installs the OV runtime wheels:\n"
