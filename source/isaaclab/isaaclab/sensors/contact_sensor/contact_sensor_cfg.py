...
class ContactSensorCfg(SensorBaseCfg):
    """Base configuration for the contact sensor.

    This contains fields common to all physics backends. For backend-specific fields, use:
    - :class:`isaaclab_physx.sensors.ContactSensorCfg` for PhysX
    ...
    """A list of body path expressions to filter contacts with. Defaults to None, meaning contacts
    with all bodies are reported.
