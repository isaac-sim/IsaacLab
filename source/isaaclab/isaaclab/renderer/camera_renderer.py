...
"""Abstract renderer interface for camera/sensor rendering (e.g. TiledCamera with Warp backend)."""
...
class Renderer:
    """Abstract interface for renderers used by TiledCamera (create_render_data, update_camera, render, write_output)."""
