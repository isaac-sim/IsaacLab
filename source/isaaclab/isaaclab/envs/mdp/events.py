...
def reset_joints_by_scale(
    ...
    joint_pos = asset.data.default_joint_pos[env_ids[:, None], asset_cfg.joint_ids].clone()
    joint_vel = asset.data.default_joint_vel[env_ids[:, None], asset_cfg.joint_ids].clone()
