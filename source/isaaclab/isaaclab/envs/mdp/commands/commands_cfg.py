...
class NullCommandCfg(CommandTermCfg):
    ...
    class_type: type | DeferredClass = DeferredClass("isaaclab.envs.mdp.commands.null_command:NullCommand")
...
class UniformVelocityCommandCfg(CommandTermCfg):
    ...
    class_type: type | DeferredClass = DeferredClass("isaaclab.envs.mdp.commands.velocity_command:UniformVelocityCommand")
...
class NormalVelocityCommandCfg(UniformVelocityCommandCfg):
    ...
    class_type: type | DeferredClass = DeferredClass("isaaclab.envs.mdp.commands.velocity_command:NormalVelocityCommand")
...
class UniformPoseCommandCfg(CommandTermCfg):
    ...
    class_type: type | DeferredClass = DeferredClass("isaaclab.envs.mdp.commands.pose_command:UniformPoseCommand")
...
class UniformPose2dCommandCfg(CommandTermCfg):
    ...
    class_type: type | DeferredClass = DeferredClass("isaaclab.envs.mdp.commands.pose_2d_command:UniformPose2dCommand")
...
class TerrainBasedPose2dCommandCfg(UniformPose2dCommandCfg):
    ...
    class_type: type | DeferredClass = DeferredClass("isaaclab.envs.mdp.commands.pose_2d_command:TerrainBasedPose2dCommand")
