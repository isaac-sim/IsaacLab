...
def _scaled_marker_cfg(
    ...
    *,
    ...
    """Create a marker configuration with one marker scaled for command visualization."""
    cfg = replace_config(marker_cfg, prim_path=prim_path)
    cfg.markers[marker_name].scale = scale
    return cfg
