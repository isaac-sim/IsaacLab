...
class Root:
    def __init__(self, root_newton_view: NewtonArticulationView, root_data: RootData, device: str):
    ...
    def write_root_link_pose_to_sim(self, pose: wp.array, env_mask: wp.array | None = None):
        ...
        # Don't need to invalidate the body pose since they will not change unless we call forward kinematics.
