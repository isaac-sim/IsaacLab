...
class RootData:
    ...
    def _create_simulation_bindings(self):
        ...
        self._sim_bind_root_mass = self._root_newton_view.get_attribute("body_mass", NewtonManager.get_model())[:, 0]
        self._sim_bind_root_inertia = self._root_newton_view.get_attribute("body_inertia", NewtonManager.get_model())[:, 0]
    ...
    def _create_buffers(self):
        ...
        try:
            ...
            self._previous_root_com_vel = wp.zeros((self._root_newton_view.count, 1), dtype=wp.spatial_vectorf, device=self.device)
    ...
    def root_com_quat_b(self) -> wp.array:
        """Root center of mass orientation (x, y, z, w) in base frame. Shape is (num_instances, 4).

        This quantity is the orientation of the root rigid body's center of mass frame with respect to the
        rigid body's actor frame.
        """
        out = wp.zeros((self._root_newton_view.count, 4), dtype=wp.quatf, device=self.device)
        wp.launch(
            split_transform_array_to_quaternion_array,
            dim=self._root_newton_view.count,
            inputs=[
                self.root_com_pose_b,
                out,
            ],
        )
        return out
    ...
    @property
    @warn_overhead_cost("root_link_pose_w", "Launches a kernel to split the transform array to a position array.")
    ...
    @property
    @warn_overhead_cost("root_link_pose_w", "Launches a kernel to split the transform array to a quaternion array.")
    ...
    @property
    @warn_overhead_cost("root_link_vel_w", "Launches a kernel to split the velocity array to a linear velocity array.")
    ...
    @property
    @warn_overhead_cost("root_link_vel_w", "Launches a kernel to split the velocity array to an angular velocity array.")
    ...
    @property
    @warn_overhead_cost("root_com_pose_w", "Launches a kernel to split the transform array to a position array.")
    ...
    @property
    @warn_overhead_cost("root_com_pose_w", "Launches a kernel to split the transform array to a quaternion array.")
    ...
    @property
    @warn_overhead_cost("root_com_vel_w", "Launches a kernel to split the velocity array to a linear velocity array.")
    ...
    @property
    @warn_overhead_cost("root_com_vel_w", "Launches a kernel to split the velocity array to an angular velocity array.")
    ...
    @property
    @warn_overhead_cost("root_link_vel_b", "Launches a kernel to split the velocity array to a linear velocity array.")
    ...
    @property
    @warn_overhead_cost("root_link_vel_b", "Launches a kernel to split the velocity array to an angular velocity array.")
    ...
    @property
    @warn_overhead_cost("root_com_vel_b", "Launches a kernel to split the velocity array to a linear velocity array.")
