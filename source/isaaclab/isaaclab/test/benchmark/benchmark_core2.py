...
class BaseIsaacLabBenchmark:
    ...
    def __init__(
        ...
        self.add_measurement("benchmark", metadata = workflow_name)
        self.add_measurement("benchmark", metadata = timestamp)
        if workflow_metadata:
            if "metadata" in workflow_metadata:
                self.add_measurement("benchmark", metadata = self._metadata_from_dict(workflow_metadata))
            else:
                logger.warning(
