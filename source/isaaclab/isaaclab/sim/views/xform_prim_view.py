...
class XformPrimView:
    ...
    def __init__(
        ...
        # Determine if Fabric is supported on the device (via SettingsManager for Newton/standalone compatibility)
        self._use_fabric = bool(get_settings_manager().get("/physics/fabricEnabled", False))
