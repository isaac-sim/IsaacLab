...
class MeshSphereCfg(MeshCfg):
    ...
    func: Callable | str = "isaaclab.sim.spawners.meshes.meshes:spawn_mesh_sphere"
...
class MeshCuboidCfg(MeshCfg):
    ...
    func: Callable | str = "isaaclab.sim.spawners.meshes.meshes:spawn_mesh_cuboid"
...
class MeshCylinderCfg(MeshCfg):
    ...
    func: Callable | str = "isaaclab.sim.spawners.meshes.meshes:spawn_mesh_cylinder"
...
class MeshCapsuleCfg(MeshCfg):
    ...
    func: Callable | str = "isaaclab.sim.spawners.meshes.meshes:spawn_mesh_capsule"
...
class MeshConeCfg(MeshCfg):
    ...
    func: Callable | str = "isaaclab.sim.spawners.meshes.meshes:spawn_mesh_cone"
...
class MeshRectangleCfg(MeshCfg):
    ...
    func: Callable | str = "isaaclab.sim.spawners.meshes.meshes:spawn_mesh_rectangle"
