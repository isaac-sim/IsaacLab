...
from isaaclab._src.benchmark.formatters import get_default_output_filename
from isaaclab._src.benchmark.interfaces import MeasurementDataRecorder
...
from isaaclab._src.benchmark.recorders import CPUInfoRecorder, GPUInfoRecorder, MemoryInfoRecorder, VersionInfoRecorder
from isaaclab._src.utils import has_kit
...
def _measurements_from_bundle(
    ...
    from isaaclab._src.benchmark.schema import PlayBundle, StartupBundle, TrainingBundle
        ...
        if self._use_recorders:
            ...
            if self._use_frametime_recorders and not has_kit():
                ...
                try:
                    ...
                    from isaaclab._src.sim.utils import enable_extension
