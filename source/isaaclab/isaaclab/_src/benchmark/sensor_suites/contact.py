...
def create_contact_sensor_scene_cfg(
    *, history_length: int, num_envs: int, env_spacing: float = 2.0
    ...
    from isaaclab._src.assets import RigidObjectCfg
    from isaaclab._src.scene import InteractiveSceneCfg
    from isaaclab._src.sensors import ContactSensorCfg
    from isaaclab._src.terrains import TerrainImporterCfg
