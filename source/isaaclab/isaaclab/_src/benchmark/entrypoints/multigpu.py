...
from isaaclab._src.cli.multigpu import MultiGpuLauncherCfg, run_multigpu_cli
...
def run_worker(argv: list[str]) -> int:
    ...
    from isaaclab._src.benchmark.dispatch import WORKFLOW_MODULES, run_training_cli
