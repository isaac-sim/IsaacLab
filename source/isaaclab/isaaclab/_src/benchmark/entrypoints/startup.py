...
def _parse_args(argv: list[str]) -> tuple[argparse.Namespace, list[str]]:
    ...
    from isaaclab._src.benchmark.distributed import add_distributed_arg
...
def run(argv: list[str]) -> BenchmarkResult | None:
    ...
    from isaaclab._src.benchmark import BaseIsaacLabBenchmark, BenchmarkResult, builders, capture, console, stepping
    ...
    from isaaclab._src.benchmark.schema import CProfileFunction, StartupPhase
