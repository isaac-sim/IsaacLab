...
import isaaclab._src.utils.sensors as sensor_utils
from isaaclab._src.app.logging_utils import force_log_level
from isaaclab._src.cloner import queue_replication
from isaaclab._src.renderers import BaseRenderer, CameraRenderSpec
from isaaclab._src.sim.views import FrameView
from isaaclab._src.utils import to_camel_case
...
class Camera(SensorBase):
    ...
    def __init__(self, cfg: CameraCfg):
        ...
        if renderer_type == "isaac_rtx":
            from isaaclab._src.app.settings_manager import get_settings_manager
