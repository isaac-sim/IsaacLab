...
from isaaclab._src.utils.string import resolve_matching_names
    ...
    * *prim_path* does not resolve to a valid prim on the stage.
    ...
    Args:
        ...
        stage: USD stage to author on. When ``None``, the current stage
            is used.
    """
    from isaaclab._src.sim import SimulationContext  # noqa: PLC0415
    ...
    from isaaclab._src.sim.utils.queries import find_first_matching_prim  # noqa: PLC0415
    from isaaclab._src.sim.utils.stage import get_current_stage  # noqa: PLC0415
...
def _author_actuator_prims(
    ...
    from isaaclab._src.actuators import DCMotorCfg, DelayedPDActuatorCfg  # noqa: PLC0415
    from isaaclab._src.actuators.actuator_net_cfg import ActuatorNetLSTMCfg, ActuatorNetMLPCfg  # noqa: PLC0415
    from isaaclab._src.actuators.actuator_pd_cfg import IdealPDActuatorCfg, RemotizedPDActuatorCfg  # noqa: PLC0415
