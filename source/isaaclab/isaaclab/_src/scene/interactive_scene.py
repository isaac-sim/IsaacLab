...
from isaaclab._src.assets import (
    Articulation,
    ArticulationCfg,
    AssetBaseCfg,
    CableObject,
...
from isaaclab._src.scene_data import REQUIRES_STAGE_AND_MODEL
from isaaclab._src.sensors import CameraCfg, ContactSensorCfg, FrameTransformerCfg, SensorBase, SensorBaseCfg
from isaaclab._src.sim import SimulationContext
from isaaclab._src.sim.utils.stage import get_current_stage, get_current_stage_id
...
class InteractiveScene:
    ...
    * For tasks that require having separate assets in the environments, ``replicate_physics`` would have to
    ...
    def _add_entities_from_cfg(self):  # noqa: C901
        ...
        from isaaclab._src.terrains.terrain_importer_cfg import TerrainImporterCfg  # noqa: PLC0415
