...
from isaaclab._src.cloner import CloneCfg, InclusionSet
from isaaclab._src.cloner import add as clone_add
from isaaclab._src.utils import find_unique_string_name
from isaaclab._src.utils.configclass import configclass

if TYPE_CHECKING:
    from isaaclab._src.assets import AssetBaseCfg
...
def _scene_assets(
    ...
    from isaaclab._src.assets import AssetBaseCfg  # noqa: PLC0415
