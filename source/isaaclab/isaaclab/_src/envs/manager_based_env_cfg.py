...
import isaaclab._src.envs.mdp as mdp
from isaaclab._src.devices.device_base import DevicesCfg

if TYPE_CHECKING:
    from isaaclab._src.devices.openxr import XrCfg
from isaaclab._src.managers import EventTermCfg as EventTerm
from isaaclab._src.managers import RecorderManagerBaseCfg as DefaultEmptyRecorderManagerCfg
from isaaclab._src.scene import InteractiveSceneCfg
from isaaclab._src.sim import SimulationCfg
...
class ManagerBasedEnvCfg:
    ...
    # ui settings
    ui_window_class_type: type | str | None = "isaaclab._src.envs.ui.base_env_window:BaseEnvWindow"
