...
import isaaclab._src.sim as sim_utils
import isaaclab._src.utils.math as math_utils
from isaaclab._src.actuators import ImplicitActuator
from isaaclab._src.managers import EventTermCfg, ManagerTermBase, SceneEntityCfg
from isaaclab._src.utils.version import compare_versions

if TYPE_CHECKING:
    from isaaclab_physx.assets import DeformableObject

    from isaaclab._src.assets import Articulation, RigidObject
    from isaaclab._src.envs import ManagerBasedEnv
    from isaaclab._src.terrains import TerrainImporter
...
class _RandomizeRigidBodyMaterialPhysx:
    ...
    def __init__(
        ...
        from isaaclab._src.assets import BaseArticulation
...
class _RandomizeRigidBodyMaterialOvPhysx:
    ...
    def __init__(
        ...
        from isaaclab._src.assets import BaseArticulation  # noqa: PLC0415
...
class randomize_rigid_body_material(ManagerTermBase):
    ...
    def __init__(self, cfg: EventTermCfg, env: ManagerBasedEnv):
        ...
        """
        from isaaclab._src.assets import BaseArticulation, BaseRigidObject
...
class randomize_rigid_body_inertia(ManagerTermBase):
    ...
    def __init__(self, cfg: EventTermCfg, env: ManagerBasedEnv):
        ...
        Raises:
            ...
            ValueError: If the upper bound is less than the lower bound.
        """
        from isaaclab._src.assets import BaseArticulation, BaseRigidObject, BaseRigidObjectCollection
