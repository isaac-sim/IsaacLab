...
from isaaclab._src.managers import ManagerTermBase, SceneEntityCfg, TerminationTermCfg

if TYPE_CHECKING:
    from isaaclab._src.assets import Articulation, RigidObject
    from isaaclab._src.envs import ManagerBasedRLEnv
    from isaaclab._src.managers.command_manager import CommandTerm
    from isaaclab._src.sensors import ContactSensor
