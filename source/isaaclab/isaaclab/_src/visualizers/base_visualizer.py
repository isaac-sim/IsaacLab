...
if TYPE_CHECKING:
    from isaaclab._src.managers import ManagerBase
    from isaaclab._src.scene_data import SceneDataProvider
...
class BaseVisualizer(ABC):
    ...
    def add_live_plots(
        ...
        if os.environ.get("ISAACLAB_DISABLE_LIVE_PLOTS", "0") == "1":
            return
        from isaaclab._src.ui.live_plots.manager_live_plots import DirectScalarLivePlots, ManagerLivePlots
