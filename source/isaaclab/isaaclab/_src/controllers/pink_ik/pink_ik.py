...
from isaaclab._src.assets import ArticulationCfg
from isaaclab._src.controllers import utils as controller_utils
from isaaclab._src.utils.assets import retrieve_file_path
from isaaclab._src.utils.string import resolve_matching_names_values
    ...
    def compute(
        ...
        def _return_current_joint_positions(error: Exception) -> torch.Tensor:
            ...
            if self.cfg.xr_enabled:
                from isaaclab._src.ui.xr_widgets import XRVisualization
