...
class SceneDataProvider:
    ...
    def get_camera_sensors(self) -> dict[str, Any]:
        ...
        if self._interactive_scene is None:
            return {}
        try:
            from isaaclab._src.sensors.camera import Camera
        except ImportError:
            return {}
        return {
            name: sensor
    ...
    def get_contact_sensors(self) -> dict[str, Any]:
        ...
        if self._interactive_scene is None:
            return {}
        from isaaclab._src.sensors.contact_sensor import BaseContactSensor
    ...
    def get_points(
        ...
        from isaaclab._src.scene_data.geometry_points import scatter_geometry_points
