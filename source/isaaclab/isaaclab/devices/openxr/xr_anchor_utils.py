...
.. deprecated::
    This module has moved to :mod:`isaaclab_teleop.xr_anchor_utils`.
    Importing from ``isaaclab.devices.openxr.xr_anchor_utils`` is deprecated and
    will be removed in a future release. Please update your imports::
...
try:
    ...
    from isaaclab_teleop.xr_anchor_utils import *  # noqa: F401,F403

    warnings.warn(
        "Importing from isaaclab.devices.openxr.xr_anchor_utils is deprecated. "
        "Please import from isaaclab_teleop.xr_anchor_utils instead.",
        DeprecationWarning,
        stacklevel=2,
    )
except ImportError:
