...
class ArticulationDataWarp:
    ...
    def default_joint_pos(self) -> wp.array:
        ...
        This quantity is configured through the :attr:`isaaclab.assets.ArticulationCfg.init_state` parameter.
        """
        return self._joint_data.default_joint_pos
    ...
    def default_joint_vel(self) -> wp.array:
        ...
        This quantity is configured through the :attr:`isaaclab.assets.ArticulationCfg.init_state` parameter.
        """
        return self._joint_data.default_joint_vel
    ...
    def joint_target(self) -> wp.array:
        ...
        """
        return self._joint_data.joint_target
    ...
    def joint_effort_target(self) -> wp.array:
        ...
        which are then set into the simulation.
        """
        return self._joint_data.joint_effort_target
    ...
    def computed_effort(self) -> wp.array:
        ...
        """
        return self._joint_data.computed_effort
    ...
    def joint_target_sim(self) -> wp.array:
        ...
        return self._joint_data.joint_target_sim

    @property
    def joint_effort_sim(self) -> wp.array:
        """Joint effort. Shape is (num_instances, num_joints)."""
        return self._joint_data.joint_effort_sim
    ...
    def joint_control_mode_sim(self) -> wp.array:
        ...
        * Velocity control: 2
        ...
        """
        return self._joint_data.joint_control_mode_sim
    ...
    def joint_stiffness_sim(self) -> wp.array:
        ...
        """
        return self._joint_data.joint_stiffness_sim
    ...
    def joint_friction_coeff(self) -> wp.array:
        ...
        return self._joint_data.joint_friction_coeff
    ...
    def joint_pos_limits_lower(self) -> wp.array:
        ...
        return self._joint_data.joint_pos_limits_lower
    ...
    def soft_joint_pos_limits(self) -> wp.array:
        ...
        """
        return self._joint_data.soft_joint_pos_limits
    ...
    def soft_joint_vel_limits(self) -> wp.array:
        ...
        """
        return self._joint_data.soft_joint_vel_limits
    ...
    def gear_ratio(self) -> wp.array:
        ...
        return self._joint_data.gear_ratio
    ...
    def root_com_pose_b(self) -> wp.array:
        ...
        """
        return self._root_data.root_com_pose_b
    ...
    def body_link_pose_w(self) -> wp.array:
        ...
        The orientation is provided in (x, y, z, w) format.
        """
        return self._body_data.body_link_pose_w
    ...
    def body_link_vel_w(self) -> wp.array:
        ...
        relative to the world.
        """
        return self._body_data.body_link_vel_w
    ...
    def body_com_pose_w(self) -> wp.array:
        ...
        The orientation is provided in (x, y, z, w) format.
        """
        return self._body_data.body_com_pose_w
    ...
    def body_com_vel_w(self) -> wp.array:
        ...
        relative to the world.
        """
        return self._body_data.body_com_vel_w
    ...
    def body_state_w(self) -> wp.array:
        ...
        return self._body_data.body_state_w
    ...
    def body_link_state_w(self) -> wp.array:
        ...
        return self._body_data.body_link_state_w
    ...
    def body_com_state_w(self) -> wp.array:
        ...
        return self._body_data.body_com_state_w
    ...
    def body_com_acc_w(self) -> wp.array:
        ...
        """
        return self._body_data.body_com_acc_w
    ...
    def body_com_pos_b(self) -> wp.array:
        ...
        """
        return self._body_data.body_com_pos_b
    ...
    def body_com_pose_b(self) -> wp.array:
        ...
        The orientation is provided in (x, y, z, w) format.
        """
        return self._body_data.body_com_pose_b
    ...
    def body_incoming_joint_wrench_b(self) -> wp.array:
        ...
        """
        return self._joint_data.body_incoming_joint_wrench_b
    ...
    def joint_acc(self) -> wp.array:
        ...
        return self._joint_data.joint_acc
    ##
    # Derived Properties.
    ##
    ...
    def root_link_vel_b(self) -> wp.array:
        ...
        """
        return self._root_data.root_link_vel_b
    ...
    def root_com_vel_b(self) -> wp.array:
        ...
        Velocity is provided in the form of [wx, wy, wz, vx, vy, vz].
        """
        return self._root_data.root_com_vel_b
    ...
    def body_link_pos_w(self) -> wp.array:
        ...
        """
        return self._body_data.body_link_pos_w
    ...
    def body_link_quat_w(self) -> wp.array:
        ...
        """
        return self._body_data.body_link_quat_w
    ...
    def body_link_lin_vel_w(self) -> wp.array:
        ...
        """
        return self._body_data.body_link_lin_vel_w
    ...
    def body_link_ang_vel_w(self) -> wp.array:
        ...
        """
        return self._body_data.body_link_ang_vel_w
    ...
    def body_com_pos_w(self) -> wp.array:
        ...
        """
        return self._body_data.body_com_pos_w
    ...
    def body_com_quat_w(self) -> wp.array:
        ...
        """
        return self._body_data.body_com_quat_w
    ...
    def body_com_lin_vel_w(self) -> wp.array:
        ...
        """
        return self._body_data.body_com_lin_vel_w
    ...
    def body_com_ang_vel_w(self) -> wp.array:
        ...
        """
        return self._body_data.body_com_ang_vel_w
    ...
    def body_com_lin_acc_w(self) -> wp.array:
        ...
        """
        return self._body_data.body_com_lin_acc_w
    ...
    def body_com_ang_acc_w(self) -> wp.array:
        ...
        """
        return self._body_data.body_com_ang_acc_w
    ...
    def body_com_quat_b(self) -> wp.array:
        ...
        """
        return self._body_data.body_com_quat_b
    ...
    def joint_pos_limits(self) -> wp.array:
        ...
        """
        return self._joint_data.joint_pos_limits
