...
AGIBOT_LEFT_ARM_RMPFLOW_CFG = RmpFlowControllerCfg(
    config_file=os.path.join(
        _CUR_DIR, "motion_policy_configs", "agibot", "rmpflow", "agibot_left_arm_rmpflow_config.yaml"
    ),
    urdf_file=os.path.join(_CUR_DIR, "motion_policy_configs", "agibot", "agibot.urdf"),
    collision_file=os.path.join(_CUR_DIR, "motion_policy_configs", "agibot", "rmpflow", "agibot_left_arm_gripper.yaml"),
...
AGIBOT_RIGHT_ARM_RMPFLOW_CFG = RmpFlowControllerCfg(
    config_file=os.path.join(
        _CUR_DIR, "motion_policy_configs", "agibot", "rmpflow", "agibot_right_arm_rmpflow_config.yaml"
    ),
    urdf_file=os.path.join(_CUR_DIR, "motion_policy_configs", "agibot", "agibot.urdf"),
    collision_file=os.path.join(
        _CUR_DIR, "motion_policy_configs", "agibot", "rmpflow", "agibot_right_arm_gripper.yaml"
    ),
