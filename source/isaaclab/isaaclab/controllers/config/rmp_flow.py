...
UR10_RMPFLOW_CFG = RmpFlowControllerCfg(
    config_file=os.path.join(_get_rmp_config_dir(), "ur10", "rmpflow", "ur10_rmpflow_config.yaml"),
    urdf_file=os.path.join(_get_rmp_config_dir(), "ur10", "ur10_robot.urdf"),
    collision_file=os.path.join(_get_rmp_config_dir(), "ur10", "rmpflow", "ur10_robot_description.yaml"),
    frame_name="ee_link",
    evaluations_per_frame=5,
)
