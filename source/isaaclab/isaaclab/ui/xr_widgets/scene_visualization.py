...
class VisualizationManager:
    ...
    def cancel_rule(self, trigger: TriggerType, arg: str | TimeCountdown, callback: Optional[Callable] = None) -> None:
    ...
    def _validate_callback_signature(self, trigger: TriggerType, callback: Callable) -> None:
        ...
        try:
            ...
            if trigger == TriggerType.TRIGGER_ON_EVENT:
                ...
                expected_count = 3
                expected_sig = "callback(manager: VisualizationManager, data_collector: DataCollector, event_params: Any)"
            else:
...
class XRVisualization:
    ...
    _instance: Optional[XRVisualization] = None
    _registered = False
    ...
    def __create_instance(cls, manager: type[VisualizationManager] = VisualizationManager) -> XRVisualization:
        ...
        with cls._lock:
            if cls._instance is None:
                ...
                cls._instance = super(XRVisualization, cls).__new__(cls)
    ...
    def assign_manager(cls, manager: type[VisualizationManager]) -> None:
        ...
        if cls._instance is not None:
            omni.log.error(f"Visualization system already initialized to {type(cls._instance._visualization_manager).__name__}, cannot assign manager {manager.__name__}")
            return
