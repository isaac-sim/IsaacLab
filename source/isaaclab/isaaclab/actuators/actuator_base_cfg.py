...
from isaaclab.utils import REQUIRED, resolve_config
...
def _is_implicit_actuator_cfg(cfg: ActuatorBaseCfg) -> bool:
    ...
    Callable import strings are resolved at this consumer boundary.
    """
    resolve_config(cfg)
...
class ActuatorBaseCfg:
    ...
    joint_names_expr: list[str] = REQUIRED
    ...
    stiffness: dict[str, float] | float | None = REQUIRED
    ...
    damping: dict[str, float] | float | None = REQUIRED
