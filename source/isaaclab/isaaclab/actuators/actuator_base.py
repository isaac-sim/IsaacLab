...
class ActuatorBase(ABC):
    ...
    def __init__(
        ...
        self.velocity_limit_sim = self._parse_joint_parameter(self.cfg.velocity_limit_sim, velocity_limit_sim)
        # -- effort
        self.effort_limit = self._parse_joint_parameter(self.cfg.effort_limit, effort_limit)
        self.effort_limit_sim = self._parse_joint_parameter(self.cfg.effort_limit_sim, effort_limit_sim)
