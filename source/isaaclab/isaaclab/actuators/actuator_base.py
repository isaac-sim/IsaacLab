...
class ActuatorBase(ABC):
    ...
    def __init__(
        ...
        if velocity_limit is not None:
            warnings.warn(
                ...
                "velocity_limit will be removed in 5.0.",
                DeprecationWarning,
                stacklevel=2,
            )
    ...
    def effort_limit(self) -> torch.Tensor:
        ...
        .. deprecated:: 3.0
            Use :attr:`actuator_effort_limit` instead. This alias will be removed in 5.0.
        """
        warnings.warn(
    ...
    def velocity_limit(self) -> torch.Tensor:
        ...
        .. deprecated:: 3.0
            Use :attr:`actuator_velocity_limit` instead. This alias will be removed in 5.0.
        """
        warnings.warn(
