...
class HfRandomUniformTerrainCfg(HfTerrainBaseCfg):
    ...
    function = DeferredClass("isaaclab.terrains.height_field.hf_terrains:random_uniform_terrain")
...
class HfPyramidStairsTerrainCfg(HfTerrainBaseCfg):
    ...
    function = DeferredClass("isaaclab.terrains.height_field.hf_terrains:pyramid_stairs_terrain")
...
class HfWaveTerrainCfg(HfTerrainBaseCfg):
    ...
    function = DeferredClass("isaaclab.terrains.height_field.hf_terrains:wave_terrain")
