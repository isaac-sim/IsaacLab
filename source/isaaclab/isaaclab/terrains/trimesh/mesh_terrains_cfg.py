...
class MeshPlaneTerrainCfg(SubTerrainBaseCfg):
    ...
    function: str = "isaaclab.terrains.trimesh.mesh_terrains:flat_terrain"
...
class MeshPyramidStairsTerrainCfg(SubTerrainBaseCfg):
    ...
    function: str = "isaaclab.terrains.trimesh.mesh_terrains:pyramid_stairs_terrain"
...
class MeshInvertedPyramidStairsTerrainCfg(MeshPyramidStairsTerrainCfg):
    ...
    function: str = "isaaclab.terrains.trimesh.mesh_terrains:inverted_pyramid_stairs_terrain"
...
class MeshRandomGridTerrainCfg(SubTerrainBaseCfg):
    ...
    function: str = "isaaclab.terrains.trimesh.mesh_terrains:random_grid_terrain"

    grid_width: float = REQUIRED
    """The width of the grid cells (in m)."""

    grid_height_range: tuple[float, float] = REQUIRED
...
class MeshRailsTerrainCfg(SubTerrainBaseCfg):
    ...
    function: str = "isaaclab.terrains.trimesh.mesh_terrains:rails_terrain"

    rail_thickness_range: tuple[float, float] = REQUIRED
    """The thickness of the inner and outer rails (in m)."""

    rail_height_range: tuple[float, float] = REQUIRED
...
class MeshPitTerrainCfg(SubTerrainBaseCfg):
    ...
    function: str = "isaaclab.terrains.trimesh.mesh_terrains:pit_terrain"

    pit_depth_range: tuple[float, float] = REQUIRED
...
class MeshBoxTerrainCfg(SubTerrainBaseCfg):
    ...
    function: str = "isaaclab.terrains.trimesh.mesh_terrains:box_terrain"

    box_height_range: tuple[float, float] = REQUIRED
...
class MeshGapTerrainCfg(SubTerrainBaseCfg):
    ...
    function: str = "isaaclab.terrains.trimesh.mesh_terrains:gap_terrain"

    gap_width_range: tuple[float, float] = REQUIRED
...
class MeshFloatingRingTerrainCfg(SubTerrainBaseCfg):
    ...
    function: str = "isaaclab.terrains.trimesh.mesh_terrains:floating_ring_terrain"

    ring_width_range: tuple[float, float] = REQUIRED
    """The minimum and maximum width of the ring (in m)."""

    ring_height_range: tuple[float, float] = REQUIRED
    """The minimum and maximum height of the ring (in m)."""

    ring_thickness: float = REQUIRED
...
class MeshStarTerrainCfg(SubTerrainBaseCfg):
    ...
    function: str = "isaaclab.terrains.trimesh.mesh_terrains:star_terrain"

    num_bars: int = REQUIRED
    """The number of bars per-side the star. Must be greater than 2."""

    bar_width_range: tuple[float, float] = REQUIRED
    """The minimum and maximum width of the bars in the star (in m)."""

    bar_height_range: tuple[float, float] = REQUIRED
...
class MeshRepeatedObjectsTerrainCfg(SubTerrainBaseCfg):
    ...
    class ObjectCfg:
        ...
        num_objects: int = REQUIRED
        """The number of objects to add to the terrain."""
        height: float = REQUIRED
        """The height (along z) of the object (in m)."""

    function: str = "isaaclab.terrains.trimesh.mesh_terrains:repeated_objects_terrain"

    object_type: Literal["cylinder", "box", "cone"] | callable = REQUIRED
    ...
    object_params_start: ObjectCfg = REQUIRED
    """The object curriculum parameters at the start of the curriculum."""

    object_params_end: ObjectCfg = REQUIRED
...
class MeshRepeatedPyramidsTerrainCfg(MeshRepeatedObjectsTerrainCfg):
    ...
    object_type: str = "isaaclab.terrains.trimesh.utils:make_cone"
...
class MeshRepeatedBoxesTerrainCfg(MeshRepeatedObjectsTerrainCfg):
    ...
    object_type: str = "isaaclab.terrains.trimesh.utils:make_box"
...
class MeshRepeatedCylindersTerrainCfg(MeshRepeatedObjectsTerrainCfg):
    ...
    object_type: str = "isaaclab.terrains.trimesh.utils:make_cylinder"
