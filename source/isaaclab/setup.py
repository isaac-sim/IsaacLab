...
INSTALL_REQUIRES = [
    ...
    "mujoco-warp @ git+https://github.com/google-deepmind/mujoco_warp.git@8f870c87272888f36dcec4e337285de55e0eaa30",
    "newton @ git+https://github.com/newton-physics/newton.git@beta-0.1.3",
    "imgui-bundle==1.92.0",
