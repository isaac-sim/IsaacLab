...
class Test_Uv_Pip_Install_Isaaclab_Rl_Tasks_Imports_Rl_Tasks(UV_Mixin):
    """Build the wheel, ``uv pip install <wheel>[rl,tasks]``, verify sub-package extras and isaacsim isolation."""
    ...
    def _build_and_install_wheel(self, isaaclab_root):
        ...
        # 2. Create the uv env and install with the rl,tasks extras (no isaacsim, no NVIDIA flags).
