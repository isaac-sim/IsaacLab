...
# -------------------------------------------------------------------------------------
# Fragment deprecation aliases and apply_drive guard
# -------------------------------------------------------------------------------------
...
def test_mujoco_joint_without_actuatorgravcomp_leaves_body_gravcomp_untouched():
    ...
    # the joint applier applies MjcJointAPI, so the attribute resolves to the schema default, but an
    # unset actuatorgravcomp must not be authored
