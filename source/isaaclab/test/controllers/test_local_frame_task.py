...
"""Unit tests for LocalFrameTask class."""
...
class TestLocalFrameTask:
    ...
    def test_initialization(self, local_frame_task):
    ...
    def test_initialization_with_sequence_costs(self):
    ...
    def test_inheritance_from_frame_task(self, local_frame_task):
    ...
    def test_set_target(self, local_frame_task):
    ...
    def test_set_target_from_configuration(self, local_frame_task, pink_config):
    ...
    def test_set_target_from_configuration_wrong_type(self, local_frame_task):
    ...
    def test_compute_error_with_target_set(self, local_frame_task, pink_config):
    ...
    def test_compute_error_without_target(self, local_frame_task, pink_config):
    ...
    def test_compute_error_wrong_configuration_type(self, local_frame_task):
    ...
    def test_compute_jacobian_with_target_set(self, local_frame_task, pink_config):
    ...
    def test_compute_jacobian_without_target(self, local_frame_task, pink_config):
        """Test that compute_jacobian raises error when no target is set."""
        with pytest.raises(TargetNotSet, match="no target set for frame 'link_2'"):
            local_frame_task.compute_jacobian(pink_config)

    def test_error_consistency_across_configurations(self, local_frame_task, pink_config):
    ...
    def test_jacobian_consistency_across_configurations(self, local_frame_task, pink_config):
    ...
    def test_error_zero_at_target_pose(self, local_frame_task, pink_config):
    ...
    def test_different_frames(self, pink_config):
    ...
    def test_different_base_frames(self, pink_config):
    ...
    def test_sequence_cost_parameters(self):
    ...
    def test_error_magnitude_consistency(self, local_frame_task, pink_config):
    ...
    def test_jacobian_structure(self, local_frame_task, pink_config):
    ...
    def test_multiple_target_updates(self, local_frame_task, pink_config):
    ...
    def test_inheritance_behavior(self, local_frame_task):
    ...
    def test_target_copying_behavior(self, local_frame_task):
    ...
    def test_error_computation_with_orientation_difference(self, local_frame_task, pink_config):
    ...
    def test_jacobian_rank_consistency(self, local_frame_task, pink_config):
