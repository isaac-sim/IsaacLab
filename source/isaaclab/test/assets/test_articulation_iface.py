...
class TestArticulationDataDefaults:
    ...
    def test_actuator_compatibility_projections_are_stable(
        ...
        torch.testing.assert_close(gear_ratio_data.torch, gear_ratio, rtol=0.0, atol=0.0)
        assert soft_joint_vel_limits_data.warp.ptr == soft_joint_vel_limits_repeat.warp.ptr
        assert gear_ratio_data.warp.ptr == gear_ratio_repeat.warp.ptr
        assert soft_joint_vel_limits_data.warp.ptr == art.actuators._soft_joint_vel_limits.ptr
        assert gear_ratio_data.warp.ptr == art.actuators._gear_ratio.ptr
