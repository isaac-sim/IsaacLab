...
def test_camera_data_allocates_supported_subset_and_rgb():
    """CameraData allocates the intersection of requested + supported output arrays."""
    ...
    assert isinstance(data.output["rgb"], wp.array)
