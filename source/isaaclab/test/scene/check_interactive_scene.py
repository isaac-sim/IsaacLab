...
def main():
    ...
    while simulation_app.is_running():
        ...
        if count % 50 == 0:
            ...
            scene.articulations["robot_1"].write_joint_state_to_sim(position=joint_pos, velocity=joint_vel)
            # -- robot 2
            root_state[:, 1] += 1.0
            ...
            scene.articulations["robot_2"].write_joint_state_to_sim(position=joint_pos, velocity=joint_vel)
            # reset buffers
            scene.reset()
            print(">>>>>>>> Reset!")
