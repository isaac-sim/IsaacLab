...
from isaaclab_tasks.core.velocity.config.cassie import agents
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point": f"{_stable_pkg}.flat_env_cfg:CassieFlatEnvCfg",
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{_stable_pkg}.flat_env_cfg:CassieFlatEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:CassieFlatPPORunnerCfg",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_flat_ppo_cfg.yaml",
    },
)
