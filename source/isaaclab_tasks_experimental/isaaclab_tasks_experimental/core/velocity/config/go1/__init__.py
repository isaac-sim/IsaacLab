...
from isaaclab_tasks.contrib.velocity.config.go1 import agents
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point": f"{_stable_pkg}.flat_env_cfg:UnitreeGo1FlatEnvCfg",
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{_stable_pkg}.flat_env_cfg:UnitreeGo1FlatEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:UnitreeGo1FlatPPORunnerCfg",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_flat_ppo_cfg.yaml",
    },
)
