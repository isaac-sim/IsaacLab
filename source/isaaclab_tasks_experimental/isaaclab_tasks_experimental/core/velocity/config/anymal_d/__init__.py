...
#     kwargs={
#         "env_cfg_entry_point": f"{_stable_pkg}.rough_env_cfg:AnymalDRoughEnvCfg",
...
#     disable_env_checker=True,
#     kwargs={
#         "env_cfg_entry_point": f"{_stable_pkg}.rough_env_cfg:AnymalDRoughEnvCfg_PLAY",
#         "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:AnymalDRoughPPORunnerCfg",
#         "skrl_cfg_entry_point": f"{agents.__name__}:skrl_rough_ppo_cfg.yaml",
#     },
# )
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{_stable_pkg}.flat_env_cfg:AnymalDFlatEnvCfg",
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{_stable_pkg}.flat_env_cfg:AnymalDFlatEnvCfg_PLAY",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:AnymalDFlatPPORunnerCfg",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_flat_ppo_cfg.yaml",
    },
)
