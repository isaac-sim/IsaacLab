...
class DeformableBodyMaterialCfg(PhysxDeformableBodyMaterialCfg):
    ...
    def __post_init__(self):
        warnings.warn(
            "'DeformableBodyMaterialCfg' is deprecated and will be removed in 4.0. Use"
...
class SurfaceDeformableBodyMaterialCfg(PhysxSurfaceDeformableBodyMaterialCfg):
    ...
    def __post_init__(self):
        warnings.warn(
            "'SurfaceDeformableBodyMaterialCfg' is deprecated and will be removed in 4.0. Use"
...
class RigidBodyMaterialCfg(PhysxRigidBodyMaterialCfg):
    ...
    def __post_init__(self):
        warnings.warn(
            "'RigidBodyMaterialCfg' is deprecated and will be removed in 4.0. Use"
