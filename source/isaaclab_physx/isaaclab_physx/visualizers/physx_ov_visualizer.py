...
class PhysxOVVisualizer(Visualizer):
    ...
    def initialize(self, scene_data: dict[str, Any] | None = None) -> None:
        ...
        has_gui = bool(self._local_gui or self._livestream_gui or self._xr_gui)
        self._sim.set_setting("/isaaclab/has_gui", has_gui)
    ...
    def _configure_rendering_dt(self):
        ...
        if self._sim.get_setting("/app/runLoops/main/rateLimitEnabled"):
