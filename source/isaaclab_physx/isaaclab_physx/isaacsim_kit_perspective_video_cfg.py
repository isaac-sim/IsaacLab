...
class IsaacsimKitPerspectiveVideoCfg:
    ...
    class_type: type[Any] | str = "isaaclab_physx.isaacsim_kit_perspective_video:IsaacsimKitPerspectiveVideo"
    """Implementation class; default is :class:`~isaaclab_physx.isaacsim_kit_perspective_video.IsaacsimKitPerspectiveVideo`."""
