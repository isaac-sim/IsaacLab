...
class IsaacRtxRendererCfg(RendererCfg):
    ...
    class_type: type[IsaacRtxRenderer] | str = "isaaclab_physx.renderers.isaac_rtx_renderer:IsaacRtxRenderer"
    """Renderer implementation class."""

    renderer_type: str = "isaac_rtx"
    """Type identifier for Isaac RTX renderer."""

    global_settings: IsaacRtxRendererGlobalSettingsCfg = field(default_factory=IsaacRtxRendererGlobalSettingsCfg)
