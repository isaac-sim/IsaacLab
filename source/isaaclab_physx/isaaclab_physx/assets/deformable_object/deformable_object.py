...
class DeformableObject(AssetBase):
    ...
    def _get_nodal_pos_w_f32(self) -> wp.array:
        """Get a cached float32 view of nodal_pos_w for PhysX TensorAPI. Invalidated in ``_create_buffers``."""
    ...
    def _get_nodal_vel_w_f32(self) -> wp.array:
        """Get a cached float32 view of nodal_vel_w for PhysX TensorAPI. Invalidated in ``_create_buffers``."""
