...
def create_prim(
    ...
    translation: tuple[float, float, float] | list[float] | None = None,
    orientation: tuple[float, float, float, float] | list[float] | None = None,
    scale: tuple[float, float, float] | list[float] | None = None,
