...
class UniformVelocityCommandCfg(CommandTermCfg):
    ...
    class Ranges:
        ...
        """Range for the linear-x velocity command."""
        lin_vel_y: tuple[float, float] = MISSING  # min max [m/s]
        """Range for the linear-y velocity command."""
        ang_vel_z: tuple[float, float] = MISSING  # min max [rad/s]
        """Range for the angular-z velocity command."""
        heading: tuple[float, float] | None = None  # min max [rad]
        """Range for the heading command. Defaults to None.
