...
.. code-block:: bash
    ...
    ./isaaclab.sh -p source/extensions/omni.isaac.lab/test/assets/check_external_force.py --body base --force 1000
    # Usage to apply force on legs
    ./isaaclab.sh -p source/extensions/omni.isaac.lab/test/assets/check_external_force.py --body .*_SHANK --force 100
"""
