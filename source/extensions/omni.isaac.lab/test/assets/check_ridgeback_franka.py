...
.. code-block:: bash
    ...
    # Usage
    ./isaaclab.sh -p source/extensions/omni.isaac.lab/test/assets/check_ridgeback_franka.py
...
# Pre-defined configs
##
from omni.isaac.lab_assets.robots.ridgeback_franka import RIDGEBACK_FRANKA_PANDA_CFG  # isort:skip
