...
from . import agents
from .cartpole_camera_env_cfg import CartpoleDepthCameraEnvCfg, CartpoleFeaturesCameraEnvCfg, CartpoleRGBCameraEnvCfg
...
gym.register(
    id="Isaac-Cartpole-Features-Camera-v0",
    entry_point="omni.isaac.lab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": CartpoleFeaturesCameraEnvCfg,
