...
from omni.isaac.lab_tasks.manipulation.cabinet import mdp
...
from omni.isaac.lab_tasks.manipulation.cabinet.cabinet_env_cfg import FRAME_MARKER_SMALL_CFG  # isort: skip
