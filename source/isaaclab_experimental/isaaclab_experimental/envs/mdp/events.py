...
def randomize_rigid_body_com(
    ...
    Writes directly into the sim-bound ``body_com_pos_b`` buffer.
    """
...
def push_by_setting_velocity(
    ...
    asset.write_root_velocity_to_sim(push_by_setting_velocity._scratch_vel, env_mask=env_mask)
...
def reset_root_state_uniform(
    ...
    asset.write_root_pose_to_sim(reset_root_state_uniform._scratch_pose, env_mask=env_mask)
    asset.write_root_velocity_to_sim(reset_root_state_uniform._scratch_vel, env_mask=env_mask)
