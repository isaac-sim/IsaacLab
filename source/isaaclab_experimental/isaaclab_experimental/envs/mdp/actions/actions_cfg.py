...
class JointPositionActionCfg(JointActionCfg):
    ...
    class_type: type[JointPositionAction] | str = (
        "isaaclab_experimental.envs.mdp.actions.joint_actions:JointPositionAction"
    )
...
class JointEffortActionCfg(JointActionCfg):
    ...
    class_type: type[JointEffortAction] | str = "isaaclab_experimental.envs.mdp.actions.joint_actions:JointEffortAction"
