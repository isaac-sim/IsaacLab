...
"""Visualizer golden image tests for the shadow hand environment on the PhysX physics backend.
...
def test_visualizer_golden(visualizer_type: str, mode: str) -> None:
    """Golden image correctness for shadow hand + PhysX across visualizer types and modes."""
