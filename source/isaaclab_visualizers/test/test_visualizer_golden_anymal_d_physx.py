...
"""Visualizer golden image tests for the AnymalD environment on the PhysX physics backend.
...
def test_visualizer_golden(visualizer_type: str, mode: str) -> None:
    """Golden image correctness for AnymalD + PhysX across visualizer types and modes."""
