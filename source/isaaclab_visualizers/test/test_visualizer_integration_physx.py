...
pytestmark = [pytest.mark.isaacsim_ci, pytest.mark.flaky(max_runs=3, min_passes=1)]


def test_cartpole_env_visualizers_motion_with_play_pause_physx(caplog: pytest.LogCaptureFixture) -> None:
    """Cartpole env + all non-tiled visualizers on PhysX."""
