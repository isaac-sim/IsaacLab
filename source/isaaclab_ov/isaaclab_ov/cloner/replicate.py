...
class OvPhysxReplicateContext:
    ...
    def __init__(self, sim_context: SimulationContext):
        ...
        self._isolate_environments = False

    def configure_environment_isolation(self, enabled: bool) -> None:
        """Select whether runtime clones receive stable clone-plan environment IDs."""
        if not isinstance(enabled, bool):
            raise TypeError("enabled must be a bool.")
        self._isolate_environments = enabled
