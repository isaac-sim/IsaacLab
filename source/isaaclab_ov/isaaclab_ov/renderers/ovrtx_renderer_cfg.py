...
class OVRTXRendererCfg(RendererCfg):
    ...
    class_type: type[OVRTXRenderer] | str = "isaaclab_ov.renderers.ovrtx_renderer:OVRTXRenderer"
    ...
    log_file_path: str = field(default_factory=lambda: os.path.join(tempfile.gettempdir(), "ovrtx_renderer.log"))
