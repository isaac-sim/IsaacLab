...
class RigidObjectData(BaseRigidObjectData):
    ...
    def __init__(
        ...
        Args:
            view: The :class:`~isaaclab_ov.sim.views.OvPhysxView` binding manager
                ...
                :meth:`~isaaclab_ov.assets.RigidObject._initialize_impl`.
    ...
    def _get_binding(self, tensor_type: int):
        ...
        :meth:`~isaaclab_ov.sim.views.OvPhysxView.try_binding_for`.
        """
    ...
    def _read_binding_into(self, tensor_type: int, dst: wp.array) -> None:
        ...
        Routes through :meth:`~isaaclab_ov.sim.views.OvPhysxView.read_into`, which
