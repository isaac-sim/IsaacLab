...
class OvPhysxCfg(PhysicsCfg):
    ...
    class_type: Any = config_field("{DIR}.ovphysx_manager:OvPhysxManager")

    cooked_collider_cache_dir: str | None = config_field(DEFAULT_COOKED_COLLIDER_CACHE_DIR)
    ...
    enable_external_forces_every_iteration: bool = config_field(False)
