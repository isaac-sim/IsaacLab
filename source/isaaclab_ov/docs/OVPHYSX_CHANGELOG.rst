OVPhysX Changelog (Archived)
----------------------------

This file preserves the release history of the former ``isaaclab_ovphysx``
distribution. New OVPhysX changes are recorded in ``CHANGELOG.rst`` as part
of the consolidated ``isaaclab_ov`` package.
