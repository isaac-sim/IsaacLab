...
def test_setting_effort_limit_implicit(sim, num_articulations, device, joint_effort_limit, effort_limit):
...
def test_setting_effort_limit_explicit(sim, num_articulations, device, joint_effort_limit, effort_limit):
