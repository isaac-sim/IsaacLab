...
from isaaclab._src.sim.schemas.schemas_cfg import MassPropertiesCfg, RigidBodyPropertiesCfg
...
from isaaclab._src.controllers.config.rmp_flow import AGIBOT_RIGHT_ARM_RMPFLOW_CFG  # isort: skip
