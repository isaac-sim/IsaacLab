...
class CtrlCfg:
    ...
    pos_action_threshold: Any = config_field([0.01, 0.01, 0.01])
...
class DisassemblyEnvCfg(DirectRLEnvCfg):
    ...
    task_name: str = config_field("extraction")  # peg_insertion, gear_meshing, nut_threading
    tasks: dict = config_field({"extraction": Extraction()})
