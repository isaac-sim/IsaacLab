...
class Extraction(DisassemblyTask):
    ...
    disassembly_dir: Any = "disassembly_dir"
    num_log_traj: Any = 100
    ...
    move_gripper_sim_steps: Any = 64
    disassemble_sim_steps: Any = 64
    ...
    fingertip_centered_pos_initial: list = field(
    ...
    fingertip_centered_rot_initial: list = field(
        default_factory=lambda: [3.141593, 0.0, 0.0]
    )  # initial rotation of fingertips (Euler)
    gripper_rand_pos_noise: list = field(default_factory=lambda: [0.05, 0.05, 0.05])
    gripper_rand_rot_noise: list = field(
        default_factory=lambda: [0.174533, 0.174533, 0.174533]
    )  # +-10 deg for roll/pitch/yaw
