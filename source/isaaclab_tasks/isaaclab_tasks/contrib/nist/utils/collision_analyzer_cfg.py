...
class CollisionAnalyzerCfg(ManagerTermBaseCfg):
    ...
    func: type[CollisionAnalyzer] | str = "isaaclab_tasks.contrib.nist.utils.collision_analyzer:CollisionAnalyzer"
    ...
    asset_cfg: SceneEntityCfg = REQUIRED
    """Scene entity whose bodies are sampled for collision checking."""

    obstacle_cfgs: list[SceneEntityCfg] = REQUIRED
