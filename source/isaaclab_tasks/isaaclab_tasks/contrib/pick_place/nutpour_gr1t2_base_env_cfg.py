...
class TerminationsCfg:
    ...
    success: Any = field(default_factory=lambda: DoneTerm(func=mdp.task_done_nut_pour))
...
class EventCfg:
    ...
    set_factory_nut_mass: Any = field(
