...
from . import agents as contrib_agents
...
gym.register(
    ...
    kwargs={
        ...
        "rl_games_lstm_cfg_entry_point": f"{contrib_agents.__name__}:rl_games_ppo_lstm_cfg.yaml",
        "rsl_rl_cfg_entry_point": f"{contrib_agents.__name__}.rsl_rl_ppo_cfg:ShadowHandAsymFFPPORunnerCfg",
        "rsl_rl_lstm_cfg_entry_point": f"{contrib_agents.__name__}.rsl_rl_ppo_cfg:ShadowHandAsymLSTMPPORunnerCfg",
