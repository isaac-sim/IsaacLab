...
class EMARelativeJointPositionActionCfg(RelativeJointPositionActionCfg):
    ...
    class_type: type[EMARelativeJointPositionAction] | str = (
        "isaaclab_tasks.contrib.franka_pour.mdp.actions:EMARelativeJointPositionAction"
    )
...
class CurriculumGripperPositionActionCfg(BinaryJointPositionActionCfg):
    ...
    class_type: type[CurriculumGripperPositionAction] | str = (
        "isaaclab_tasks.contrib.franka_pour.mdp.actions:CurriculumGripperPositionAction"
    )
