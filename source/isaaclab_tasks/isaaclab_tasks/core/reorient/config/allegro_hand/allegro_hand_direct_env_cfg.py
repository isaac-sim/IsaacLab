...
class AllegroHandEnvCfg(DirectRLEnvCfg):
    ...
    action_space: Any = config_field(16)
    observation_space: Any = config_field(124)  # (full)
    ...
    # robot
    robot_cfg: ArticulationCfg = config_field(ALLEGRO_HAND_ROBOT_CFG)
    ...
    success_tolerance: Any = config_field(0.2)
