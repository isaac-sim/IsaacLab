...
"""Ant locomotion environments (similar to OpenAI Gym Ant-v2).

This package consolidates the direct-workflow and manager-based-workflow ant tasks. Module files carry
a ``_direct_`` or ``_manager_`` infix to disambiguate the two workflows within the flat package layout.
"""
