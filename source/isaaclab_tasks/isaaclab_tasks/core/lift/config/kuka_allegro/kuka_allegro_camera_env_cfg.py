...
class SingleCameraSceneCfg(KukaAllegroSceneCfg):
    ...
    base_camera: CameraCfg = field(default_factory=BaseTiledCameraCfg)
...
class DuoCameraSceneCfg(KukaAllegroSceneCfg):
    ...
    base_camera: CameraCfg = field(default_factory=BaseTiledCameraCfg)
    wrist_camera: CameraCfg = field(default_factory=WristTiledCameraCfg)
...
class KukaAllegroReorientCameraEnvCfg(PresetCfg):
    single_camera: Any = field(
        default_factory=lambda: _camera_env(
            KukaAllegroReorientEnvCfg, SingleCameraSceneCfg, SingleCameraObservationsCfg
        )
    )
    duo_camera: Any = field(
        default_factory=lambda: _camera_env(KukaAllegroReorientEnvCfg, DuoCameraSceneCfg, DuoCameraObservationsCfg)
    )
    default: Any = field(
        default_factory=lambda: _camera_env(
            KukaAllegroReorientEnvCfg, SingleCameraSceneCfg, SingleCameraObservationsCfg
...
class KukaAllegroLiftCameraEnvCfg(PresetCfg):
    single_camera: Any = field(
        default_factory=lambda: _camera_env(KukaAllegroLiftEnvCfg, SingleCameraSceneCfg, SingleCameraObservationsCfg)
    )
    duo_camera: Any = field(
        default_factory=lambda: _camera_env(KukaAllegroLiftEnvCfg, DuoCameraSceneCfg, DuoCameraObservationsCfg)
    )
    default: Any = field(
        default_factory=lambda: _camera_env(KukaAllegroLiftEnvCfg, SingleCameraSceneCfg, SingleCameraObservationsCfg)
    )
