...
@configclass
class DexsuiteFrankaPPOBaseRunnerCfg(RslRlOnPolicyRunnerCfg):
...
@configclass
class DexsuiteFrankaPPORunnerCfg(PresetCfg):
    default = DexsuiteFrankaPPOBaseRunnerCfg().replace(
        experiment_name="dexsuite_franka",
