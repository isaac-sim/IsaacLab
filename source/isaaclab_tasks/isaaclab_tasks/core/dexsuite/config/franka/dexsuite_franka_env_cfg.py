...
class FrankaSceneCfg(dexsuite.SceneCfg):
    ...
    def __post_init__(self):
        ...
        graspable_shape_assets_cfg = [
            ...
            MeshCapsuleCfg(radius=0.025, height=0.1, **dexsuite.OBJECT_PHYSICS),
            MeshCapsuleCfg(radius=0.025, height=0.2, **dexsuite.OBJECT_PHYSICS),
            MeshCapsuleCfg(radius=0.01, height=0.2, **dexsuite.OBJECT_PHYSICS),
        ]
