...
if TYPE_CHECKING:
    ...
    from .pendulum_marl_manager_env_cfg import PendulumMARLManagerEnvCfg

__all__ = ["PendulumMARLEnv", "PendulumMARLEnvCfg", "PendulumMARLManagerEnvCfg"]
...
def __getattr__(name: str):
    ...
    if name == "PendulumMARLManagerEnvCfg":
        from .pendulum_marl_manager_env_cfg import PendulumMARLManagerEnvCfg

        return PendulumMARLManagerEnvCfg
...
gym.register(
    id="Isaac-Pendulum-MARL",
    entry_point="isaaclab.envs:ManagerBasedMARLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}:PendulumMARLManagerEnvCfg",
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_marl_ppo_cfg.yaml",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_marl_ppo_cfg.yaml",
        "skrl_ippo_cfg_entry_point": f"{agents.__name__}:skrl_marl_ippo_cfg.yaml",
        "skrl_mappo_cfg_entry_point": f"{agents.__name__}:skrl_marl_mappo_cfg.yaml",
