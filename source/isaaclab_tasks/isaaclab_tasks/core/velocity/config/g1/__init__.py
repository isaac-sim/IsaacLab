...
gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-Yms-DepthDistill",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.rough_29dof_depth_distill_env_cfg:G129DofRoughYmsDepthDistillEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_cfg:G129DofRoughAirTime100DepthDistillationRunnerCfg"
        ),
...
gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-Mj-DepthDistill",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.rough_29dof_depth_distill_env_cfg:G129DofRoughMjDepthDistillEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_cfg:G129DofRoughAirTime100DepthDistillationRunnerCfg"
        ),
...
gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-Ysu-DepthDistill-Noisy",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.rough_29dof_depth_distill_env_cfg:G129DofRoughYsuDepthDistillNoisyEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_cfg:G129DofRoughAirTime100DepthDistillationRunnerCfg"
        ),
...
gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-Mj-DepthDistill-Noisy",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.rough_29dof_depth_distill_env_cfg:G129DofRoughMjDepthDistillNoisyEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_cfg:G129DofRoughAirTime100DepthDistillationRunnerCfg"
        ),
...
gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-Nf-DepthDistill",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.rough_29dof_depth_distill_env_cfg:G129DofRoughNfDepthDistillEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_cfg:G129DofRoughAirTime100DepthDistillationRunnerCfg"
        ),
...
gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-Yhk-DepthDistill",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.rough_29dof_depth_distill_env_cfg:G129DofRoughYhkDepthDistillEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_cfg:G129DofRoughAirTime100DepthDistillationRunnerCfg"
        ),
...
gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-Ysu-DepthDistill",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.rough_29dof_depth_distill_env_cfg:G129DofRoughYsuDepthDistillEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": (
            f"{agents.__name__}.rsl_rl_ppo_cfg:G129DofRoughAirTime100DepthDistillationRunnerCfg"
        ),
...
gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-Explicit-Sym",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.rough_29dof_explicit_env_cfg:G129DofRoughExplicitEnvCfg"
        ),
...
gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-MjlabAll",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.rough_29dof_mjlabobs_env_cfg:G129DofRoughMjlabObsEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1RoughMjlabPPORunnerCfg",
    },
)


gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-MjlabTerrain",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.rough_29dof_mjlabterrain_env_cfg:G129DofRoughMjlabTerrainEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1RoughPPORunnerCfg",
    },
)
...
gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-MjlabClone",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.rough_29dof_mjlabclone_env_cfg:G129DofRoughMjlabCloneEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1RoughPPORunnerCfg",
    },
)
...
gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-MjlabFull",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.rough_29dof_mjlabfull_env_cfg:G129DofRoughMjlabFullEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1RoughPPORunnerCfg",
    },
)
...
gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-MjlabScale-NoFingers",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.rough_29dof_mjlab_env_cfg:G129DofRoughMjlabScaleNoFingersEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1RoughPPORunnerCfg",
    },
)
...
gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-MjlabScale-HwTorque",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.rough_29dof_mjlab_env_cfg:G129DofRoughMjlabScaleHwTorqueEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1RoughPPORunnerCfg",
    },
)
...
gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-MjlabScale-HipKnee",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.rough_29dof_mjlab_env_cfg:G129DofRoughMjlabScaleHipKneeEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1RoughPPORunnerCfg",
    },
)
...
gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-MjlabScale-HipKnee-Sym",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
...
gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-MujocoAligned",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.rough_29dof_mjalign_env_cfg:G129DofRoughMujocoAlignedEnvCfg"
        ),
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1RoughPPORunnerCfg",
    },
)
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.rough_29dof_mjalign_env_cfg:G129DofRoughMujocoAlignedDREnvCfg"
        ),
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:G1RoughSymmetryPPORunnerCfg",
    },
)
...
gym.register(
    id="Isaac-Velocity-Rough-G1-29Dof-AirTime100-MujocoAligned-Sym",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
