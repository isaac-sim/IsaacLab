...
class RoughPhysicsCfg(PresetCfg):
    ...
    ovphysx: Any = field(default_factory=lambda: OvPhysxCfg(gpu_max_rigid_patch_count=10 * 2**15))
    physx: Any = field(
...
class RewardsCfg:
    ...
    # -- penalties
    lin_vel_z_l2: Any = field(default_factory=lambda: RewTerm(func=mdp.lin_vel_z_l2, weight=-2.0))
    ang_vel_xy_l2: Any = field(default_factory=lambda: RewTerm(func=mdp.ang_vel_xy_l2, weight=-0.05))
    dof_torques_l2: Any = field(default_factory=lambda: RewTerm(func=mdp.joint_torques_l2, weight=-1.0e-5))
    dof_acc_l2: Any = field(default_factory=lambda: RewTerm(func=mdp.joint_acc_l2, weight=-2.5e-7))
    action_rate_l2: Any = field(default_factory=lambda: RewTerm(func=mdp.action_rate_l2, weight=-0.01))
    ...
    # -- optional penalties
    flat_orientation_l2: Any = field(default_factory=lambda: RewTerm(func=mdp.flat_orientation_l2, weight=0.0))
    dof_pos_limits: Any = field(default_factory=lambda: RewTerm(func=mdp.joint_pos_limits, weight=0.0))
...
class CurriculumCfg:
    ...
    terrain_levels: Any = field(default_factory=lambda: CurrTerm(func=mdp.terrain_levels_vel))
...
class LocomotionVelocityRoughEnvCfg(ManagerBasedRLEnvCfg):
    ...
    sim: SimulationCfg = field(default_factory=lambda: SimulationCfg(physics=RoughPhysicsCfg()))
    # Scene settings
