...
gym.register(
    id="Isaac-Repose-Cube-Allegro-Play",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Isaac-Repose-Cube-Allegro-Direct",
    entry_point="isaaclab_tasks.core.inhand.inhand_direct_env:InHandDirectEnv",
    disable_env_checker=True,
    kwargs={
