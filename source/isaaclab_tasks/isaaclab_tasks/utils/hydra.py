...
Override order (strict): Presets > Groups > Single field.
    Within same type: lower depth > higher depth; left > right (rightmost wins).
    1. Global presets: `presets=noise_less` -> apply everywhere matching
...
Example usage:
    # Apply "noise_less" preset everywhere it exists, then override scale
    presets=noise_less env.actions.arm_action.scale=0.5 env.sim.dt=0.01
"""
