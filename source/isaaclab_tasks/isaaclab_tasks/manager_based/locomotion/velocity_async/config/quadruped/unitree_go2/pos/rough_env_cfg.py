...
from isaaclab_tasks.manager_based.locomotion.velocity_async.velocity_env_cfg import LocomotionVelocityRoughEnvCfg
...
class Go2RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # self.commands.base_velocity.ranges.lin_vel_x = (1.0, 1.0)  # (0.0, 0.0) (1.0, 1.0)
