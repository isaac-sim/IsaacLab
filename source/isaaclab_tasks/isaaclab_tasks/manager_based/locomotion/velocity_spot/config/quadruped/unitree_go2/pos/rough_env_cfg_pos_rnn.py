...
@configclass
class UnitreeGo2RoughEnvCfg_pos_rnn(LocomotionVelocityRoughEnvCfg):
    base_link_name = "base"
    ...
    def __post_init__(self):
        ...
        self.rewards.joint_pos_hip.weight = -0.1

        # If the weight of rewards is 0, set rewards to None
        if self.__class__.__name__ == "UnitreeGo2RoughEnvCfg_pos_rnn":
...
@configclass
class UnitreeGo2RoughEnvCfg_pos_rnn_PLAY(UnitreeGo2RoughEnvCfg_pos_rnn):
    def __post_init__(self):
        super().__post_init__()
