...
@configclass
class UnitreeGo2RoughEnvCfg_all_rnn(LocomotionVelocityRoughEnvCfg):
    base_link_name = "base"
    ...
    def __post_init__(self):
        ...
        # self.scene.robot.actuators["legs"].stiffness = 15.0
        # self.scene.robot.actuators["legs"].damping = 0.3
        ...
        self.actions.joint_vel.joint_names = self.joint_names
        self.actions.joint_eff.scale = 1.0
        self.actions.joint_eff.joint_names = self.joint_names
        ...
        self.rewards.action_smoothness_joint_pos.weight = -1.0
        # self.rewards.gait.weight = 0.0
        # self.rewards.base_height_l2.weight = 0.0

        if self.__class__.__name__ == "UnitreeGo2RoughEnvCfg_all_rnn":
