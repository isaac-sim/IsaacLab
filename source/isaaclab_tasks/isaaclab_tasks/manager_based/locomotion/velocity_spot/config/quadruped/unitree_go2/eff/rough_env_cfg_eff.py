...
@configclass
class UnitreeGo2RoughEnvCfg_eff(LocomotionVelocityRoughEnvCfg):
    base_link_name = "base"
    ...
    def __post_init__(self):
        ...
        if self.__class__.__name__ == "UnitreeGo2RoughEnvCfg_eff":
...
@configclass
class UnitreeGo2RoughEnvCfg_eff_PLAY(UnitreeGo2RoughEnvCfg_eff):
    def __post_init__(self):
        super().__post_init__()
