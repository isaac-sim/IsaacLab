...
@configclass
class UnitreeGo2RoughEnvCfg_eff_rnn(LocomotionVelocityRoughEnvCfg):
    base_link_name = "base"
    ...
    def __post_init__(self):
        ...
        self.actions.joint_eff.scale = 0.1
        ...
        if self.__class__.__name__ == "UnitreeGo2RoughEnvCfg_eff_rnn":
