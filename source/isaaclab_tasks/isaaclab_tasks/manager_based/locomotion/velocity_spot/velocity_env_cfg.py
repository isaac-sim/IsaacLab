...
import isaaclab_tasks.manager_based.locomotion.velocity_spot.mdp as mdp
import isaaclab_tasks.manager_based.locomotion.velocity_spot.spot_mdp as spot_mdp
...
class EventCfg:
    ...
    randomize_push_robot = EventTerm(
        ...
        params={
            "velocity_range": {
                "x": (-0.5, 0.5), # (-0.5, 0.5) (-2.0, 2.0)
                "y": (-0.5, 0.5)  # (-0.5, 0.5) (-2.0, 2.0)
            }
        },
    )
