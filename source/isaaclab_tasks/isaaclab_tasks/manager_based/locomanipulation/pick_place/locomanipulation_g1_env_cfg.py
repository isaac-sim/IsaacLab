...
from isaaclab.devices.retargeters import (
    DexBiManualRetargeterCfg,
    DexHandRetargeterCfg,
    DexMotionControllerCfg,
    Se3AbsRetargeterCfg,
)
from isaaclab.devices.retargeters.locomotion import LocomotionFixedRootCmdRetargeterCfg, LocomotionRootCmdRetargeterCfg
        ...
        self.teleop_devices = DevicesCfg(
            devices={
                ...
                "motion_controllers": OpenXRDeviceCfg(
                    retargeters=[
                        Se3AbsRetargeterCfg(
                            bound_hand=DeviceBase.TrackingTarget.CONTROLLER_LEFT,
                            # Offset equivalent to (0, -75, 90) Euler (XYZ)
                            target_offset_rot=(0.5358, -0.4619, 0.5358, 0.4619),
                            zero_out_xy_rotation=False,
                            use_wrist_rotation=True,
                            use_wrist_position=True,
                            sim_device=self.sim.device,
                        ...
                        Se3AbsRetargeterCfg(
                            ...
                            # Offset equivalent to (0, -75, 90) Euler (XYZ) but mirrored for right hand?
                            target_offset_rot=(0.5358, -0.4619, 0.5358, 0.4619),
                            zero_out_xy_rotation=False,
                            use_wrist_rotation=True,
                            use_wrist_position=True,
                        ...
                        DexMotionControllerCfg(
                            target=DeviceBase.TrackingTarget.CONTROLLER_LEFT,
                            hand_joint_names=left_hand_joints,
                            sim_device=self.sim.device,
                            hand_urdf=f"{ISAACLAB_NUCLEUS_DIR}/Controllers/LocomanipulationAssets/unitree_g1_dexpilot_asset/G1_left_hand.urdf",
                        ),
                        DexMotionControllerCfg(
                            target=DeviceBase.TrackingTarget.CONTROLLER_RIGHT,
                            hand_joint_names=right_hand_joints,
                            sim_device=self.sim.device,
                            hand_urdf=f"{ISAACLAB_NUCLEUS_DIR}/Controllers/LocomanipulationAssets/unitree_g1_dexpilot_asset/G1_right_hand.urdf",
                        ),
                        LocomotionRootCmdRetargeterCfg(
                            sim_device=self.sim.device,
                        ),
                    ],
                    sim_device=self.sim.device,
