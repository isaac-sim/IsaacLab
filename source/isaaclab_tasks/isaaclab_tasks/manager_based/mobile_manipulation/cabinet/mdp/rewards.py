...
#     """
#     ee_tcp_pos = env.scene["ee_R_frame"].data.target_pos_w[..., 0, :]
...
#     """
#     ee_tcp_quat = env.scene["ee_R_frame"].data.target_quat_w[..., 0, :]
...
#     ee_fingertips_w = env.scene["ee_R_frame"].data.target_pos_w[..., 1:, :]
