...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point": f"{__name__}.franka_mobile_reach_env_cfg:FrankaMobileReachEnvCfg",
...
gym.register(
    ...
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.franka_mobile_reach_env_cfg:FrankaMobileReachEnvCfg_PLAY",
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_ppo_cfg.yaml",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:FrankaMobileReachPPORunnerCfg",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_ppo_cfg.yaml",
    },
