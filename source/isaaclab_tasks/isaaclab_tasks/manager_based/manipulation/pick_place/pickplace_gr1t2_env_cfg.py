...
# TODO: comment back in when XR is supported again
...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    # Table
    # TODO: comment back in when packing table asset can be loaded
    ...
    # TODO: comment back in when streering wheel asset can be loaded
    ...
    robot: ArticulationCfg = GR1T2_HIGH_PD_CFG.replace(
        ...
        init_state=ArticulationCfg.InitialStateCfg(
            pos=(0, 0, 0.93),
            # rot=(0.0, 0.0, 0.0, 1.0),  # Identity quaternion (no rotation)
...
class PickPlaceGR1T2EnvCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.actions.upper_body_ik.controller.urdf_path = "/tmp/urdf/GR1T2_fourier_hand_6dof.urdf"
        ...
        # TODO: disabling teleop devices until it is supported again
