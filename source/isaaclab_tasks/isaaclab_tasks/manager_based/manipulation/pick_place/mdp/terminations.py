...
def task_done_pick_place(
    ...
    """
    if relevant_link_name == "":
        raise ValueError("relevant_link_name must be provided to task_done_pick_place")
    ...
    right_eef_idx = env.scene["robot"].data.body_names.index(relevant_link_name)
