...
class GearAssemblySceneCfg(InteractiveSceneCfg):
    ...
    factory_gear_base = RigidObjectCfg(
        ...
        # XYZW quaternion: (0.70711, 0.0, 0.0, 0.70711) -> 90 deg rotation about x-axis
        # Converted from WXYZ (0.70711, 0.70711, 0.0, 0.0)
    ...
    factory_gear_small = RigidObjectCfg(
        ...
        # XYZW quaternion: same as gear_base
        init_state=RigidObjectCfg.InitialStateCfg(pos=(-1.0200, 0.2100, -0.1), rot=(0.70711, 0.0, 0.0, 0.70711)),
    )
    ...
    sim: SimulationCfg = SimulationCfg(
        newton_cfg=NewtonCfg(
            solver_cfg=MJWarpSolverCfg(
                njmax=500,  # High for contact-rich gear insertion
                nconmax=300,  # Many contact points from gear teeth
