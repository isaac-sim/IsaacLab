...
class ComputeKeypointDistance(ManagerTermBase):
    ...
    def __init__(self, cfg: RewardTermCfg, env: ManagerBasedRLEnv):
        ...
        self.keypoint_offsets_base = get_keypoint_offsets_full_6d(
...
class KeypointCommandError(ManagerTermBase):
    """Compute keypoint distance between current and desired poses from command.

    This class-based term uses ComputeKeypointDistance internally.
    """
    ...
    def __init__(self, cfg: RewardTermCfg, env: ManagerBasedRLEnv):
        ...
        self.keypoint_computer = ComputeKeypointDistance(cfg, env)
...
class KeypointCommandErrorExp(ManagerTermBase):
    """Compute exponential keypoint reward between current and desired poses from command.

    This class-based term uses ComputeKeypointDistance internally and applies
...
class KeypointEntityError(ManagerTermBase):
...
class KeypointEntityErrorExp(ManagerTermBase):
