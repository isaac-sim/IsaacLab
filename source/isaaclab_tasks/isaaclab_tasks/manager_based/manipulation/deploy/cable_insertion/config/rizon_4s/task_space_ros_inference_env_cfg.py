...
"""Task-space ROS inference configuration for cable insertion with Flexiv Rizon 4S.

Inherits from the task-space training config and adds Isaac Manipulator
metadata fields plus Hubble Lab deployment alignment.
"""
...
from .task_space_env_cfg import Rizon4sTaskSpaceCableInsertionEnvCfg, _ACTION_SCALE
...
@configclass
class Rizon4sTaskSpaceCableInsertionROSInferenceEnvCfg(Rizon4sTaskSpaceCableInsertionEnvCfg):
