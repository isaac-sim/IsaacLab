...
class FrankaBinStackEnvCfg(StackEnvCfg):
    def __post_init__(self):
        ...
        self.scene.cube_1 = RigidObjectCfg(
            ...
            init_state=RigidObjectCfg.InitialStateCfg(pos=(0.4, 0.0, 0.025), rot=(0.0, 0.0, 0.0, 0.1)),
            spawn=UsdFileCfg(
        ...
        self.scene.cube_2 = RigidObjectCfg(
            ...
            init_state=RigidObjectCfg.InitialStateCfg(pos=(0.85, 0.25, 0.0203), rot=(0.0, 0.0, 0.0, 0.1)),
            spawn=UsdFileCfg(
