...
class CabinetSceneCfg(InteractiveSceneCfg):
    ...
    cabinet = ArticulationCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            usd_path=str(workspace) + "/assets/bernie_proj/cabinet.usd",
...
class EventCfg:
    ...
    # reset the joints of the cabinet
...
class CabinetEnvCfg(ManagerBasedRLEnvCfg):
    ...
    # Scene settings
    scene: CabinetSceneCfg = CabinetSceneCfg(num_envs=4096, env_spacing=5.0)
    # Basic settings
