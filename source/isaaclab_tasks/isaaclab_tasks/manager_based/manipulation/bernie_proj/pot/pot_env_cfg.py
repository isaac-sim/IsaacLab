...
class PotSceneCfg(InteractiveSceneCfg):
    ...
    # Object on the table. In this case a pot
    pot = RigidObjectCfg(
        prim_path="{ENV_REGEX_NS}/pot",
        init_state=RigidObjectCfg.InitialStateCfg(pos=[1, 0, 1], rot=[1, 0, 0, 0]),
        spawn=UsdFileCfg(
            usd_path="/home/davin123/IsaacLab/assets/bernie_proj/pot.usd",
            scale=(0.2, 0.2, 0.2),
...
class PotEnvCfg(ManagerBasedRLEnvCfg):
    ...
    # Scene settings
    scene: PotSceneCfg = PotSceneCfg(num_envs=4096, env_spacing=5.0)
    # Basic settings
