...
# Pre-defined configs
##
from isaaclab.terrains.config.floating_obstacles import FLOATING_OBSTACLES_CFG  # isort: skip
...
class ActionsCfg:
    ...
    joint_pos = mdp.JointThrustActionCfg(asset_name="robot", joint_names=[".*"], scale=0.5, use_default_offset=True)
