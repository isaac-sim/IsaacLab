...
def update_task_param(task_cfg, assembly_id, disassembly_dir):
    ...
    for line in lines:
        if 'assembly_id =' in line:
            ...
            line = disassembly_dir_pattern.sub(r"\1'{}'".format(disassembly_dir), line)
...
def main():
    ...
    parser.add_argument("--disassembly_dir", type=str, help="Path to the directory containing output disassembly trajectories.", default="disassembly_dir")
