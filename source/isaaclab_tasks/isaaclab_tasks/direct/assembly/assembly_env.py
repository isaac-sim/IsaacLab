...
class AssemblyEnv(DirectRLEnv):
    ...
    def _init_eval_loading(self):
        eval_held_asset_pose, eval_fixed_asset_pose, eval_success = automate_log.load_log_from_hdf5(self.cfg_task.eval_filename)
    ...
    def _load_assembly_info(self):
        ...
        in_file = open(os.path.basename(self.cfg_task.plug_grasp_json), 'r')
        ...
        in_file = open(os.path.basename(self.cfg_task.disassembly_dist_json), 'r')
    ...
    def _load_disassembly_data(self):
        ...
        in_file = open(os.path.basename(self.cfg_task.disassembly_path_json), 'r')
