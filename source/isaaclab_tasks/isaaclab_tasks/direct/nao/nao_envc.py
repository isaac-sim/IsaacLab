...
@configclass
class NaoEnvcCfg(DirectRLEnvCfg):
    # env
    episode_length_s = 15.0
    decimation = 2
    action_scale = 1.0
    action_space = 20  # Updated to match the number of joints
    ...
    angular_velocity_scale: float = 0.0000025
    contact_force_scale: float = 0.0000001



class NaoEnvc(LocomotionEnv):
    cfg: NaoEnvcCfg

    def __init__(self, cfg: NaoEnvcCfg, render_mode: str | None = None, **kwargs):
