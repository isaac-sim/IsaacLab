...
_SHOWCASE_CFG_PATH = f"{__name__}.cartpole_camera_env_cfg:CartpoleCameraShowcasePresetsEnvCfg"
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point": deprecated_task_alias(
            ...
            "--task=Isaac-Cartpole-Camera-Showcase-Direct-v0 presets=box_box",
            _SHOWCASE_CFG_PATH,
        ),
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_box_box_ppo_cfg.yaml",
    },
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point": deprecated_task_alias(
            ...
            "--task=Isaac-Cartpole-Camera-Showcase-Direct-v0 presets=dict_box --agent=skrl_dict_box_cfg_entry_point",
            _SHOWCASE_CFG_PATH,
        ),
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point": deprecated_task_alias(
            ...
            "--task=Isaac-Cartpole-Camera-Showcase-Direct-v0 presets=tuple_box --agent=skrl_tuple_box_cfg_entry_point",
            _SHOWCASE_CFG_PATH,
        ),
