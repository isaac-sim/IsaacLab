...
class ShadowHandSceneCfg(PresetCfg):
    ...
    mjwarp: InteractiveSceneCfg = InteractiveSceneCfg(
...
class ShadowHandEnvCfg(DirectRLEnvCfg):
    ...
    # scene — use ShadowHandSceneCfg so that presets=mjwarp disables clone_in_fabric automatically
