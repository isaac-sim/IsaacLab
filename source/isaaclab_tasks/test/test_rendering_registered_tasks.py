...
_RENDER_CORRECTNESS_TASK_IDS = [
    ("Isaac-Cartpole-Camera-Direct-v0", None, "cartpole"),
    ("Isaac-Cartpole-Camera-Direct-v0", "albedo", "cartpole"),
    ("Isaac-Cartpole-Camera-Direct-v0", "depth", "cartpole"),
    ("Isaac-Cartpole-Camera-Direct-v0", "rgb", "cartpole"),
    ("Isaac-Cartpole-Camera-Direct-v0", "simple_shading_constant_diffuse", "cartpole"),
    ("Isaac-Cartpole-Camera-Direct-v0", "simple_shading_diffuse_mdl", "cartpole"),
    ("Isaac-Cartpole-Camera-Direct-v0", "simple_shading_full_mdl", "cartpole"),
    pytest.param(
