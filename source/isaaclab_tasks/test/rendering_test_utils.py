...
def rendering_test_franka_cloth(
    ...
    from isaaclab_tasks.core.lift.config.franka_soft.franka_camera_env_cfg import FrankaClothCameraEnvCfg
...
def rendering_test_franka_soft(
    ...
    from isaaclab_tasks.core.lift.config.franka_soft.franka_camera_env_cfg import FrankaSoftCameraEnvCfg
