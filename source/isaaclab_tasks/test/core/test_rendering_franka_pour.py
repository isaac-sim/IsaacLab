...
"""Rendering correctness tests for test-local Franka pour camera setup."""
...
def test_rendering_franka_pour(physics_backend, renderer, data_type):
    """Test Franka pour rendering correctness."""
