...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Isaac-Reorient-KukaAllegro-Camera", "ovphysx,ovrtx,rgb64,single_camera"),
        ("Isaac-Lift-KukaAllegro-Camera", "ovphysx,ovrtx,rgb64,single_camera"),
    ],
)
def test_ovphysx_camera_preset_resolves_kitless(task_name: str, presets: str):
    ...
    For the Kuka tasks, ``ovphysx`` alone must also select the supported object, event, and curriculum configs.
    """
