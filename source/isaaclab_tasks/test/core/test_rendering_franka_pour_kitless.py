...
"""Kit-less rendering correctness tests for test-local Franka pour camera setup."""
...
def test_rendering_franka_pour_kitless(physics_backend, renderer, data_type):
    """Camera output must match golden images for the Franka pour test setup."""
    rendering_test_franka_pour(physics_backend, renderer, data_type, _COMPARISON_SCORES)
