...
"""Rendering correctness tests for Shadow Hand with Newton and Isaac Sim RTX."""
...
@pytest.mark.parametrize("physics_backend,renderer,data_type", NEWTON_ISAACSIM_RTX_AOV_COMBINATIONS)
def test_rendering_shadow_hand_newton_isaacsim_rtx(physics_backend, renderer, data_type):
    """Test Shadow Hand rendering with Newton and Isaac Sim RTX."""
