...
@pytest.mark.parametrize(
    ...
    [
        pytest.param("Isaac-Reach-Franka", 1, 8, "matrix_free", 0.05, 1.0e-6, 1 / 60, 2, id="reach-franka"),
        pytest.param("Isaac-Reach-UR10", 1, 8, "matrix_free", 0.05, 1.0e-6, 1 / 60, 2, id="reach-ur10"),
