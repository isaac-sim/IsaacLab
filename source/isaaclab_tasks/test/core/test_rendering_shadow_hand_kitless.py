...
"""Kit-less rendering correctness tests for Shadow Hand environment backend combinations."""
...
_RENDERING_PARAMS = make_kitless_rendering_params(KITLESS_PHYSICS_RENDERER_AOV_BATCHES)
