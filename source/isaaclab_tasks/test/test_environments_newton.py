...
@pytest.mark.xfail(
    reason=(
        "TODO: Nested PresetCfg resolution for named presets (e.g. 'mjwarp') is not yet supported. "
...
def test_environments_newton(task_name, num_envs, device):
    ...
    _run_environments(task_name, device, num_envs, physics_preset_name="mjwarp", create_stage_in_memory=False)
