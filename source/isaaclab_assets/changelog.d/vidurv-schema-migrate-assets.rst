...
* Migrated the shipped robot configurations to the composable physics-schema fragment API.
  ...
  itself. Articulation self-collision is authored for both backends, by
  ...
  mirrored automatically. The authored USD attributes are unchanged. Code that tuned a shipped configuration
