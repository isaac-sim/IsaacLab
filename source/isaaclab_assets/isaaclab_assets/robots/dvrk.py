...
"""Joint limits of the pinned PSM jaws, in :data:`DVRK_PSM_JAW_JOINT_NAMES` order."""

DVRK_PSM_JAW_OPEN_POS = (-math.pi / 6.0, math.pi / 6.0)
"""Fully-open jaw endpoint, in :data:`DVRK_PSM_JAW_JOINT_NAMES` order."""

DVRK_PSM_JAW_CLOSED_POS = (0.0, 0.0)
"""Fully-closed jaw endpoint, in :data:`DVRK_PSM_JAW_JOINT_NAMES` order."""
