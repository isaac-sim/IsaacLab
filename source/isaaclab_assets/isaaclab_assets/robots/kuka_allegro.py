...
* :obj:`KUKA_ALLEGRO_RANDOMIZABLE_CFG`: Kuka Allegro with randomizable visual materials.
...
KUKA_ALLEGRO_RANDOMIZABLE_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{ISAACLAB_NUCLEUS_DIR}/Robots/KukaAllegro/kuka.usd",
        activate_contact_sensors=True,
        randomizable_visual_materials=True,  # Enable spawn-time material creation
        randomizable_visual_materials_mode="style",  # "style" = preserve color groups, "full" = all random
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=True,
            retain_accelerations=True,
            linear_damping=0.0,
