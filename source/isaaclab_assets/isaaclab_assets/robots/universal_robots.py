...
UR10_LONG_SUCTION_CFG.spawn.rigid_props[0].disable_gravity = True
...
UR10e_ROBOTIQ_GRIPPER_CFG.spawn.rigid_props[0].disable_gravity = True
...
UR10e_ROBOTIQ_2F_85_CFG.spawn.rigid_props[0].disable_gravity = True
