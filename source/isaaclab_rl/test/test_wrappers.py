...
def test_wrapper_rejects_gymnasium_time_limit(library: str) -> None:
    """Reject Gymnasium's scalar time limit before framework-specific validation."""
    import gymnasium as gym

    env = gym.wrappers.TimeLimit(gym.Env(), max_episode_steps=10)
