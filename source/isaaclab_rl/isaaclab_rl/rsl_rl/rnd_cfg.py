...
class RslRlRndCfg:
    ...
    class LinearWeightScheduleCfg(WeightScheduleCfg):
        ...
        final_value: float = REQUIRED
        """The final value of the weight parameter."""

        initial_step: int = REQUIRED
    ...
    predictor_hidden_dims: list[int] = field(default_factory=lambda: [-1])
    ...
    target_hidden_dims: list[int] = field(default_factory=lambda: [-1])
