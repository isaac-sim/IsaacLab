...
class RslRlPpoCNNActorCriticCfg(RslRlPpoActorCriticCfg):
    ...
    cnn_paddings: list = MISSING
    cnn_dilations: list = MISSING
...
@configclass
class RslRlPpoCNNActorCriticRecurrentCfg(RslRlPpoActorCriticCfg):
    """Configuration for the PPO actor-critic networks with recurrent layers."""

    class_name: str = "CNNActorCriticRecurrent"
    """The policy class name. Default is ActorCriticRecurrent."""
    ...
    cnn_kernel_size: int = MISSING
    cnn_stride: int = MISSING
    cnn_filters: list = MISSING
    paddings: list = MISSING
