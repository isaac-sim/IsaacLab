...
class RslRlCNNModelCfg(RslRlMLPModelCfg):
    ...
    @dataclass
    class CNNCfg:
        output_channels: tuple[int] | list[int] = REQUIRED
        """The number of output channels for each convolutional layer for the CNN."""

        kernel_size: int | tuple[int] | list[int] = REQUIRED
...
class RslRlPpoAlgorithmCfg:
    ...
    entropy_coef: float = REQUIRED
    """The coefficient for the entropy loss."""

    desired_kl: float = REQUIRED
    ...
    value_loss_coef: float = REQUIRED
    """The coefficient for the value loss."""

    use_clipped_value_loss: bool = REQUIRED
    """Whether to use clipped value loss."""

    clip_param: float = REQUIRED
...
class RslRlBaseRunnerCfg:
    ...
    num_steps_per_env: int = REQUIRED
    ...
    empirical_normalization: bool = REQUIRED
    ...
    obs_groups: dict[str, list[str]] = REQUIRED
...
class RslRlOnPolicyRunnerCfg(RslRlBaseRunnerCfg):
    ...
    actor: RslRlMLPModelCfg = REQUIRED
    """The actor configuration."""

    critic: RslRlMLPModelCfg = REQUIRED
    """The critic configuration."""

    algorithm: RslRlPpoAlgorithmCfg = REQUIRED
    """The algorithm configuration."""

    policy: RslRlPpoActorCriticCfg = REQUIRED
...
class RslRlPpoActorCriticCfg:
    ...
    actor_obs_normalization: bool = REQUIRED
    """Whether to normalize the observation for the actor network."""

    critic_obs_normalization: bool = REQUIRED
    """Whether to normalize the observation for the critic network."""

    actor_hidden_dims: list[int] = REQUIRED
    """The hidden dimensions of the actor network."""

    critic_hidden_dims: list[int] = REQUIRED
