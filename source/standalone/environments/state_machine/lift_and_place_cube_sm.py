...
.. code-block:: bash
    ...
    ./isaaclab.sh -p source/standalone/environments/state_machine/lift_and_place_cube_sm.py --num_envs 32
...
from omni.isaac.lab_tasks.manager_based.manipulation.lift.lift_place_env_cfg import LiftEnvCfg
