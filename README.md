...
This is the stable release branch for Isaac Lab 3.0.0 EA and supports Isaac Sim 6.1.0. Use the
[`v3.0.0-EA`](https://github.com/isaac-sim/IsaacLab/tree/v3.0.0-EA) tag for a reproducible release checkout.
Active feature development continues on the
[`develop`](https://github.com/isaac-sim/IsaacLab/tree/develop) branch.
...
- [Installation steps](https://isaac-sim.github.io/IsaacLab/v3.0.0-EA/source/setup/installation/index.html#local-installation)
- [Reinforcement learning](https://isaac-sim.github.io/IsaacLab/v3.0.0-EA/source/overview/reinforcement-learning/rl_existing_scripts.html)
- [Tutorials](https://isaac-sim.github.io/IsaacLab/v3.0.0-EA/source/tutorials/index.html)
