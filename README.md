...
```
conda run -n lerobot python scripts/tools/convert_hdf5_to_lerobot.py --hdf5 logs/demos/visuomotor.hdf5 --output ~/Stanley_ws/IsaacLab/datasets/openarm_visuomotor --task "Pick up the red cube." --fps 30 --cameras front_cam wrist_cam body_cam
```
