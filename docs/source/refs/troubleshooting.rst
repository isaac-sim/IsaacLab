...
.. tab-set::
   ...
   .. tab-item:: uv (Recommended)
      ...
      .. code:: bash
          ...
          uv run --extra isaacsim isaaclab demo bipeds --kit_args "--/persistent/physics/omniPvdOvdRecordingDirectory=/tmp/ --/physics/omniPvdOutputEnabled=true"
   ...
   .. tab-item:: isaaclab.sh / isaaclab.bat
      ...
      .. code:: bash
          ...
          ./isaaclab.sh demo bipeds --kit_args "--/persistent/physics/omniPvdOvdRecordingDirectory=/tmp/ --/physics/omniPvdOutputEnabled=true"
