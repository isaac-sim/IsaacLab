...
.. code:: bash
    ...
    ./isaaclab.sh -p scripts/demos/bipeds.py --kit_args "--/persistent/physics/omniPvdOvdRecordingDirectory=/tmp/ --/physics/omniPvdOutputEnabled=true" --visualizer none
...
.. code-block:: bash
    ...
    ./isaaclab.sh -p scripts/tutorials/00_sim/create_empty.py --visualizer none --info
