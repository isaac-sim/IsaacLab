...
.. code:: bash
    ...
    ./isaaclab.sh -p source/standalone/workflows/sb3/train.py --task Isaac-Cartpole-Manager --headless --cpu

Now:

.. code:: bash

    ./isaaclab.sh -p source/standalone/workflows/sb3/train.py --task Isaac-Cartpole-Manager --headless --device cpu
