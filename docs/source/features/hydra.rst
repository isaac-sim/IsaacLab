...
.. tab-set::
    ...
    .. tab-item:: rsl_rl
        ...
        .. code-block:: shell
            ...
            python scripts/reinforcement_learning/train.py --library rsl_rl --task=Isaac-Cartpole-v0 --headless env.actions.joint_effort.scale=10.0 agent.seed=2024
    ...
    .. tab-item:: rl_games
        ...
        .. code-block:: shell
            ...
            python scripts/reinforcement_learning/train.py --library rl_games --task=Isaac-Cartpole-v0 --headless env.actions.joint_effort.scale=10.0 agent.params.seed=2024
    ...
    .. tab-item:: skrl
        ...
        .. code-block:: shell
            ...
            python scripts/reinforcement_learning/train.py --library skrl --task=Isaac-Cartpole-v0 --headless env.actions.joint_effort.scale=10.0 agent.seed=2024
    ...
    .. tab-item:: sb3
        ...
        .. code-block:: shell
            ...
            python scripts/reinforcement_learning/train.py --library sb3 --task=Isaac-Cartpole-v0 --headless env.actions.joint_effort.scale=10.0 agent.seed=2024
