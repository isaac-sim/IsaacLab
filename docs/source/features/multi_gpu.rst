...
For aggregate throughput and timing measurements, use the separate experimental
:ref:`benchmark-multigpu-training`. The benchmark supports RSL-RL, RL-Games, and
skrl Torch, but not skrl JAX.
