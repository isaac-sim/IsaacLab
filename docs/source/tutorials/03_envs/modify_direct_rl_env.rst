...
.. code-block:: bash
  ...
  ./isaaclab.sh -p scripts/reinforcement_learning/train.py --library rl_games --task Isaac-H1-Direct-v0 --headless
...
.. code-block:: bash
  ...
  ./isaaclab.sh -p scripts/reinforcement_learning/play.py --library rl_games --task Isaac-H1-Direct-v0 --num_envs 64 --viz kit
