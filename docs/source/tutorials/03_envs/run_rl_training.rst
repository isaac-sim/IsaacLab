...
.. code-block:: bash
  ...
  ./isaaclab.sh -p scripts/reinforcement_learning/train.py --library sb3 --task Isaac-Cartpole-v0 --num_envs 64
...
.. code-block:: bash
  ...
  ./isaaclab.sh -p scripts/reinforcement_learning/train.py --library sb3 --task Isaac-Cartpole-v0 --num_envs 64 --video
...
.. code-block:: bash
  ...
  ./isaaclab.sh -p scripts/reinforcement_learning/train.py --library sb3 --task Isaac-Cartpole-v0 --num_envs 64 --viz kit
...
.. code:: bash
   ...
   # execute from the root directory of the repository
   ./isaaclab.sh -p scripts/reinforcement_learning/play.py --library sb3 --task Isaac-Cartpole-v0 --num_envs 32 --use_last_checkpoint --viz kit
