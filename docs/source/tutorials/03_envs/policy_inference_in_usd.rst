...
.. code-block:: bash
   ...
   ./isaaclab.sh train --library rsl_rl --task Isaac-Velocity-Rough-H1-v0 --headless
...
.. code-block:: bash
   ...
   ./isaaclab.sh play --library rsl_rl --task Isaac-Velocity-Rough-H1-v0 --num_envs 64 --checkpoint logs/rsl_rl/h1_rough/EXPERIMENT_NAME/POLICY_FILE.pt --viz kit
