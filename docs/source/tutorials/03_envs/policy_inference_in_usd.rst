...
.. code-block:: bash
  ...
  ./isaaclab.sh -p scripts/reinforcement_learning/train.py --library rsl_rl --task Isaac-Velocity-Rough-H1-v0 --headless
...
.. code-block:: bash
  ...
  ./isaaclab.sh -p scripts/reinforcement_learning/play.py --library rsl_rl --task Isaac-Velocity-Rough-H1-v0 --num_envs 64 --checkpoint logs/rsl_rl/h1_rough/EXPERIMENT_NAME/POLICY_FILE.pt --viz kit
