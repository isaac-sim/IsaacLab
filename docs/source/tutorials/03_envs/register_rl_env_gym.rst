...
.. code-block:: bash
   ...
   ./isaaclab.sh -p scripts/environments/random_agent.py --task Isaac-Cartpole-Manager --num_envs 32 --viz kit
...
.. code-block:: bash
   ...
   ./isaaclab.sh -p scripts/environments/random_agent.py --task Isaac-Cartpole-Manager --num_envs 32 --device cpu --viz kit
