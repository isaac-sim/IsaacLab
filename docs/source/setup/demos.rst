...
Focused programs for learning an API, tuning a feature, or supporting documentation are packaged separately as
examples. List them with ``uvx isaaclab example list`` and run one with ``uvx isaaclab example <name>``.
   ...
   <div class="environment-browser demo-browser" data-demo-browser>
     ...
     <div class="demo-card-grid" data-demo-list>
       <button type="button" class="demo-card is-selected" aria-pressed="true"
               ...
               data-demo-visualizers-isaacsim-physx="none,kit,rerun,viser"
       ...
       <button type="button" class="demo-card" aria-pressed="false"
               data-demo-name="Newton Dominoes" data-demo-id="newton-dominoes"
               data-demo-physics="newton_xpbd" data-demo-fixed-physics="true"
               data-demo-visualizers="newton_gl"
               data-demo-description="Interact with an XPBD domino scene in the Newton viewer.">
         <span>Newton Dominoes</span>
       </button>
       <button type="button" class="demo-card" aria-pressed="false"
...
The H1 locomotion and pick-and-place demos require interactive keyboard or mouse input.
