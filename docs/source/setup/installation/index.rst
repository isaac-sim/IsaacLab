...
+---------------------+---------------------------------------------------+
| ``newton``          | Newton physics + Newton visualizer                |
+---------------------+---------------------------------------------------+
| ``physx``           | PhysX physics                                     |
+---------------------+---------------------------------------------------+
| ``tasks``           | Built-in task environments                        |
+---------------------+---------------------------------------------------+
| ``assets``          | Robot and object configurations                   |
+---------------------+---------------------------------------------------+
| ``visualizers``     | All visualizer backends                           |
+---------------------+---------------------------------------------------+
| ``rl``              | ``isaaclab_rl`` (no framework)                    |
+---------------------+---------------------------------------------------+
| ``rsl_rl``          | RSL-RL framework (auto-includes ``isaaclab_rl``)  |
+---------------------+---------------------------------------------------+
| ``skrl``            | skrl framework                                    |
+---------------------+---------------------------------------------------+
| ``sb3``             | Stable Baselines3 framework                       |
+---------------------+---------------------------------------------------+
| ``rl_games``        | rl_games framework                                |
+---------------------+---------------------------------------------------+
| ``robomimic``       | robomimic framework                               |
+---------------------+---------------------------------------------------+
| ``all`` or (empty)  | All sub-packages + all RL frameworks              |
+---------------------+---------------------------------------------------+
| ``none``            | Core ``isaaclab`` package only                    |
+---------------------+---------------------------------------------------+
