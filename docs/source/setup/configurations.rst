.. _isaac-lab-configurations:

Configurations
=======================

This guide covers the most common concepts you will encounter as you build your own
projects with Isaac Lab! This includes running RL, finding environments, creating new projects, and more!

The power of Isaac Lab comes from a few key features that we will briefly touch on in this guide.
...
for more generalized development.  For the purposes of this guide, we will only focus on the Direct workflow.
...
For details on how robots are defined as configuration instances in Isaac Lab, see :ref:`isaac-lab-robots`.
