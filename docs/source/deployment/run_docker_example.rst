...
We will execute the script to produce a log, adding a ``--visualizer none`` flag to our execution to prevent a GUI:

.. code-block:: bash

  isaaclab -p scripts/tutorials/00_sim/log_time.py --visualizer none
