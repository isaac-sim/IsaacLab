...
.. code-block:: bash
    ...
    python scripts/reinforcement_learning/rsl_rl/train.py --task Isaac-Cartpole-Manager --viz kit,newton,rerun

    # Launch only the Newton visualizer
    python scripts/reinforcement_learning/rsl_rl/train.py --task Isaac-Cartpole-Manager --viz newton

    # Launch the Viser web-based visualizer
    python scripts/reinforcement_learning/rsl_rl/train.py --task Isaac-Cartpole-Manager --viz viser
...
.. code-block:: bash
    ...
    python scripts/reinforcement_learning/rsl_rl/train.py --task Isaac-Cartpole-Manager
...
.. code-block:: bash
    ...
    python scripts/reinforcement_learning/rsl_rl/train.py --task Isaac-Cartpole-Manager --viz rerun --num_envs 512
