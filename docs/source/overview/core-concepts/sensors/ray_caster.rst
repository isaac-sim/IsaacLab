...
The ray-casting implementation depends on the physics backend. With PhysX and
OV PhysX, configured meshes are loaded into `Warp <https://nvidia.github.io/warp/>`_
