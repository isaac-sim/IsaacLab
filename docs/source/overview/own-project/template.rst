  ...
  .. tab-set::
    ...
    .. tab-item:: :icon:`fa-brands fa-linux` Linux
        ...
        .. code-block:: bash
          ...
          python scripts/reinforcement_learning/train.py --library <specific-rl-library> --task=<Task-Name>
    ...
    .. tab-item:: :icon:`fa-brands fa-windows` Windows
        ...
        .. code-block:: batch
          ...
          python scripts\reinforcement_learning\train.py --library <specific-rl-library> --task=<Task-Name>
