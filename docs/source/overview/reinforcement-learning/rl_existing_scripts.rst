...
All training and play scripts support the **Newton physics backend** via the ``presets=mjwarp``
Hydra override. Appending ``presets=mjwarp`` to any command below switches the physics engine
...
.. code:: bash
   ...
   ./isaaclab.sh -p scripts/reinforcement_learning/<framework>/train.py \
       --task <task-name> --headless presets=mjwarp

.. note::

   **Not all environments support the Newton backend yet.** Using ``presets=mjwarp`` with an
   ...
   .. tab-set::
      ...
      .. tab-item:: :icon:`fa-brands fa-linux` Linux
         ...
         .. code:: bash
            ...
            ./isaaclab.sh -p scripts/reinforcement_learning/rl_games/train.py --task Isaac-Ant-v0 --headless presets=mjwarp
      ...
      .. tab-item:: :icon:`fa-brands fa-windows` Windows
         ...
         .. code:: batch
            ...
            :: run script for training with Newton backend
            isaaclab.bat -p scripts\reinforcement_learning\rl_games\train.py --task Isaac-Ant-v0 --headless presets=mjwarp
            :: run script for playing with 32 environments
   ...
   .. tab-set::
      ...
      .. tab-item:: :icon:`fa-brands fa-linux` Linux
         ...
         .. code:: bash
            ...
            # run script for training with Newton backend
            ./isaaclab.sh -p scripts/reinforcement_learning/rsl_rl/train.py --task Isaac-Reach-Franka-v0 --headless presets=mjwarp
            # run script for playing with 32 environments
      ...
      .. tab-item:: :icon:`fa-brands fa-windows` Windows
         ...
         .. code:: batch
            ...
            :: run script for training with Newton backend
            isaaclab.bat -p scripts\reinforcement_learning\rsl_rl\train.py --task Isaac-Reach-Franka-v0 --headless presets=mjwarp
            :: run script for playing with 32 environments
   ...
   .. tab-set::
      ...
      .. tab-item:: :icon:`fa-brands fa-linux` Linux
         ...
         .. code:: bash
            ...
            ./isaaclab.sh -p scripts/reinforcement_learning/rsl_rl/train.py --task Isaac-Velocity-Flat-Anymal-D-v0 --headless presets=mjwarp
      ...
      .. tab-item:: :icon:`fa-brands fa-windows` Windows
         ...
         .. code:: batch
            ...
            :: run script for rl training of the teacher agent with Newton backend
            isaaclab.bat -p scripts\reinforcement_learning\rsl_rl\train.py --task Isaac-Velocity-Flat-Anymal-D-v0 --headless presets=mjwarp
            :: run script for distilling the teacher agent into a student agent
   ...
   .. tab-set::
            ...
            .. tab-set::
               ...
               .. tab-item:: :icon:`fa-brands fa-linux` Linux
                  ...
                  .. code:: bash
                     ...
                     # run script for training with Newton backend
                     ./isaaclab.sh -p scripts/reinforcement_learning/skrl/train.py --task Isaac-Reach-Franka-v0 --headless presets=mjwarp
                     # run script for playing with 32 environments
               ...
               .. tab-item:: :icon:`fa-brands fa-windows` Windows
                  ...
                  .. code:: batch
                     ...
                     :: run script for training with Newton backend
                     isaaclab.bat -p scripts\reinforcement_learning\skrl\train.py --task Isaac-Reach-Franka-v0 --headless presets=mjwarp
                     :: run script for playing with 32 environments
      ...
      .. tab-item:: JAX
         ...
         .. code:: bash
            ...
            # run script for training with Newton backend
            ./isaaclab.sh -p scripts/reinforcement_learning/skrl/train.py --task Isaac-Reach-Franka-v0 --headless --ml_framework jax presets=mjwarp
            # run script for playing with 32 environments
   ...
   .. tab-set::
      ...
      .. tab-item:: :icon:`fa-brands fa-linux` Linux
         ...
         .. code:: bash
            ...
            # run script for training with Newton backend
            ./isaaclab.sh -p scripts/reinforcement_learning/sb3/train.py --task Isaac-Velocity-Flat-Unitree-A1-v0 --headless presets=mjwarp
            # run script for playing with 32 environments
      ...
      .. tab-item:: :icon:`fa-brands fa-windows` Windows
         ...
         .. code:: batch
            ...
            :: run script for training with Newton backend
            isaaclab.bat -p scripts\reinforcement_learning\sb3\train.py --task Isaac-Velocity-Flat-Unitree-A1-v0 --headless presets=mjwarp
            :: run script for playing with 32 environments
