   ...
   .. tab-set::
      ...
      .. tab-item:: :icon:`fa-brands fa-linux` Linux
         ...
         .. code:: bash
            ...
            ./isaaclab.sh -p scripts/reinforcement_learning/rl_games/train.py --task Isaac-Ant-v0 --visualizer none
      ...
      .. tab-item:: :icon:`fa-brands fa-windows` Windows
         ...
         .. code:: batch
            ...
            :: run script for training
            isaaclab.bat -p scripts\reinforcement_learning\rl_games\train.py --task Isaac-Ant-v0 --visualizer none
            :: run script for playing with 32 environments
   ...
   .. tab-set::
      ...
      .. tab-item:: :icon:`fa-brands fa-linux` Linux
         ...
         .. code:: bash
            ...
            # run script for training
            ./isaaclab.sh -p scripts/reinforcement_learning/rsl_rl/train.py --task Isaac-Reach-Franka-v0 --visualizer none
            # run script for playing with 32 environments
      ...
      .. tab-item:: :icon:`fa-brands fa-windows` Windows
         ...
         .. code:: batch
            ...
            :: run script for training
            isaaclab.bat -p scripts\reinforcement_learning\rsl_rl\train.py --task Isaac-Reach-Franka-v0 --visualizer none
            :: run script for playing with 32 environments
   ...
   .. tab-set::
      ...
      .. tab-item:: :icon:`fa-brands fa-linux` Linux
         ...
         .. code:: bash
            ...
            ./isaaclab.sh -p scripts/reinforcement_learning/rsl_rl/train.py --task Isaac-Velocity-Flat-Anymal-D-v0 --visualizer none
      ...
      .. tab-item:: :icon:`fa-brands fa-windows` Windows
         ...
         .. code:: batch
            ...
            isaaclab.bat -i rsl_rl
            :: run script for rl training of the teacher agent
            isaaclab.bat -p scripts\reinforcement_learning\rsl_rl\train.py --task Isaac-Velocity-Flat-Anymal-D-v0 --visualizer none
            :: run script for distilling the teacher agent into a student agent
   ...
   .. tab-set::
            ...
            .. tab-set::
               ...
               .. tab-item:: :icon:`fa-brands fa-linux` Linux
                  ...
                  .. code:: bash
                     ...
                     ./isaaclab.sh -i skrl
                     # run script for training
                     ./isaaclab.sh -p scripts/reinforcement_learning/skrl/train.py --task Isaac-Reach-Franka-v0 --visualizer none
                     # run script for playing with 32 environments
               ...
               .. tab-item:: :icon:`fa-brands fa-windows` Windows
                  ...
                  .. code:: batch
                     ...
                     isaaclab.bat -i skrl
                     :: run script for training
                     isaaclab.bat -p scripts\reinforcement_learning\skrl\train.py --task Isaac-Reach-Franka-v0 --visualizer none
                     :: run script for playing with 32 environments
      ...
      .. tab-item:: JAX
         ...
         .. code:: bash
            ...
            # run script for training
            ./isaaclab.sh -p scripts/reinforcement_learning/skrl/train.py --task Isaac-Reach-Franka-v0 --visualizer none --ml_framework jax
            # run script for playing with 32 environments
   ...
   .. tab-set::
      ...
      .. tab-item:: :icon:`fa-brands fa-linux` Linux
         ...
         .. code:: bash
            ...
            ./isaaclab.sh -i sb3
            # run script for training
            ./isaaclab.sh -p scripts/reinforcement_learning/sb3/train.py --task Isaac-Velocity-Flat-Unitree-A1-v0 --visualizer none
            # run script for playing with 32 environments
      ...
      .. tab-item:: :icon:`fa-brands fa-windows` Windows
         ...
         .. code:: batch
            ...
            isaaclab.bat -i sb3
            :: run script for training
            isaaclab.bat -p scripts\reinforcement_learning\sb3\train.py --task Isaac-Velocity-Flat-Unitree-A1-v0 --visualizer none
            :: run script for playing with 32 environments
