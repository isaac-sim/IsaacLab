...
.. code-block:: bash
   ...
   python scripts/benchmarks/benchmark_rsl_rl.py --task=Isaac-Cartpole-Manager --headless

   # benchmark with RL Games
   python scripts/benchmarks/benchmark_rlgames.py --task=Isaac-Cartpole-Manager --headless

   # benchmark without RL libraries
   python scripts/benchmarks/benchmark_non_rl.py --task=Isaac-Cartpole-Manager --headless
