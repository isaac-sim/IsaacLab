...
(() => {
    ...
    const initializeEnvironmentBrowser = () => {
        ...
        ["Isaac-Reach-Franka", "rl_games,rsl_rl,skrl", "newton_kamino,newton_mjwarp,physx", "", ""],
        ["Isaac-Reach-Franka-Newton-IK-Rel", "rsl_rl", "", "", ""],
        ["Isaac-Reach-Franka-OSC", "rsl_rl", "newton_kamino,newton_mjwarp,physx", "", ""],
        ["Isaac-Reach-Franka-Warp-v0", "rl_games,rsl_rl,skrl", "", "", ""],
        ["Isaac-Reach-UR10", "rl_games,rsl_rl,skrl", "newton_kamino,newton_mjwarp,physx", "", ""],
