...
from control.observation import get_observation
...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene):
    ...
    while simulation_app.is_running():
        ...
        if count % 500 == 0:
            ...
            #print(observation["observation/wrist_image"].shape)
...
def main():
    ...
    scene_cfg = X7SceneCfg(num_envs=args_cli.num_envs, env_spacing=2.0)
    scene = InteractiveScene(scene_cfg)
